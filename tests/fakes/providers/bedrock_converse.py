...
The real ``boto3`` ``bedrock-runtime`` client inside ShellGPT is pointed here through botocore's
...
class FakeBedrock:
    ...
    def client_env(self) -> dict[str, str]:
        """Env for a ShellGPT child: botocore endpoint override + fake static credentials."""
