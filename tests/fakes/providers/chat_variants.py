...
The vendor boundary behind ShellGPT' ``chat_completions`` transport as spoken by the
...
Vendor-host impersonation: routes ShellGPT gates by hostname (``openrouter.ai``,
