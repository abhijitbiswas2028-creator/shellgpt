...
The external boundary ShellGPT' ``codex_responses`` transport talks to (ChatGPT Codex,
...
# nothing to resolve against (a foreign/unpersisted id 404s), so ShellGPT replays these items
