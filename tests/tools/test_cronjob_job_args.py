...
hardcoded "~/.shellgpt/scripts/" in its messages even though resolution goes
through get_shellgpt_home(), which is per-profile.
"""
...
class TestValidateCronScriptPath:
    ...
    def test_missing_file_error_names_the_resolved_scripts_dir(self):
        ...
        # under profiles, where get_shellgpt_home() is not the global ~/.shellgpt.
        scripts_dir = get_shellgpt_home() / "scripts"
