...
from tools.mcp_oauth_provider import ShellGPTProviderMixin  # noqa: E402


class _Provider(ShellGPTProviderMixin, OAuthClientProvider):
    pass
...
def _provider_for(issuer: str, *, iss_in_redirect: str | None) -> _Provider:
    ...
    provider._shellgpt_oauth_flow = "browser"
    return provider
