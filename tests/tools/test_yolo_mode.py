"""Tests for --yolo (SHELLGPT_YOLO_MODE) approval bypass."""
...
class TestYoloMode:
    """When SHELLGPT_YOLO_MODE is set, all dangerous commands are auto-approved."""
    ...
    def test_dangerous_command_blocked_normally(self, monkeypatch):
        ...
        monkeypatch.setenv("SHELLGPT_SESSION_KEY", "test-session")
    ...
    def test_dangerous_command_approved_in_yolo_mode(self, monkeypatch):
        """With SHELLGPT_YOLO_MODE, dangerous commands are auto-approved."""
    ...
    def test_false_like_yolo_values_do_not_bypass_dangerous_command(self, monkeypatch, value):
        ...
        monkeypatch.setenv("SHELLGPT_YOLO_MODE", value)
        monkeypatch.setenv("SHELLGPT_INTERACTIVE", "1")
        monkeypatch.setenv("SHELLGPT_SESSION_KEY", "test-session")
