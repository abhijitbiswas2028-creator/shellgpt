...
class TestWriteDenyExactPaths:
    ...
    def test_shellgpt_root_env_when_running_under_profile(self, tmp_path, monkeypatch):
        ...
        ``~/.shellgpt/.env`` (whose credentials are inherited by every profile)
        ...
        # Sanity check: SHELLGPT_HOME does point to the profile dir, not the root.
...
class TestWriteAllowed:
    ...
    def test_shellgpt_control_files_requested_writable(self):
