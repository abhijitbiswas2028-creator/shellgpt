...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and shellgpt-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # shellgpt-agent (tests/skills/)
]
