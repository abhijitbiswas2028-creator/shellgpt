...
@pytest.mark.parametrize("platform, present, absent", [
    ("cli", "shellgpt honcho peer --user", "Do not suggest peerName"),
    ("telegram", "Do not suggest peerName", "shellgpt honcho peer --user"),
])
...
@pytest.mark.parametrize("platform, present, absent", [
    ("cli", "shellgpt honcho peer --user", "could not be initialized"),
    ("discord", "supplied no user id", "shellgpt honcho peer --user"),
])
