...
against a gateway-wide enum (``none``..``max``; ShellGPT-internal ``ultra`` is rejected). The
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"enabled": True, "effort": "ultra"}, {"reasoning_effort": "max"}),  # ShellGPT-internal tier clamps
