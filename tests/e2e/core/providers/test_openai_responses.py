"""OpenAI Responses (Codex) wire conformance through REAL ShellGPT processes.
...
request ShellGPT sends against the SDK's request schema. The provider is a config-defined
