...
* listing — ``shellgpt_cli.models.provider_model_ids`` (the catalog the ``/model`` picker renders)
...
* switch — ``shellgpt_cli.model_switch.switch_model(explicit_provider=<row>)`` must resolve to that
