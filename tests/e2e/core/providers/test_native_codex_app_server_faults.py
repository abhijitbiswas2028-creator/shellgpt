"""codex_app_server faults and approval edges: real ``shellgpt chat -q`` against a fake ``codex app-server``.
...
ShellGPT must answer (approval in single-query mode, permissions) plus process-tree teardown.
"""
