"""Bedrock Converse / ConverseStream fault semantics through the real ``shellgpt chat -q`` CLI.
...
SCENARIOS: dict[str, Scenario] = {
    # botocore's own retries are off (documented AWS_MAX_ATTEMPTS) so the 429 reaches ShellGPT' loop.
