...
through the real ShellGPT MCP client (discovery, transport, liveness checks, result
...
shutdown tests can prove ShellGPT reaps the whole process tree, not just its direct
