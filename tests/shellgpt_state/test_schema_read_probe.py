...
``shellgpt_cli.web_server_sessions._open_session_db_at_path``. These tests pin the
...
from shellgpt_state_common import DEFERRED_INDEX_SQL, SCHEMA_SQL
from shellgpt_state_schema import SessionSchemaMixin, schema_read_probe_statements
