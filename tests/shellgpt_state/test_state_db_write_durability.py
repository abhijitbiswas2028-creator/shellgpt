...
The defect: shellgpt_state already knows macOS `fsync()` does not guarantee
...
from shellgpt_state import repair_state_db_schema
from shellgpt_state_repair import _connect_repair_durable
