"""Session <-> workspace grouping key (shellgpt_state_sessions.workspace_key).

The key is what `shellgpt sessions list --workspace` groups/filters on. It is a
...
import shellgpt_state_sessions
from shellgpt_state_sessions import workspace_key
