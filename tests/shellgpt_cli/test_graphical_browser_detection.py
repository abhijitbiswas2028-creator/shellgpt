"""Tests for `_can_open_graphical_browser()` in shellgpt_cli.auth.

Guards the fix for the May 2026 report where `shellgpt auth add xai-oauth`
...
from shellgpt_cli.auth import _can_open_graphical_browser
