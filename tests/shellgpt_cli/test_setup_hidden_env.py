...
class TestChannelCards:
    ...
    def test_hidden_knobs_move_to_the_keys_page_not_into_a_void(self):
        ...
        from shellgpt_cli.web_server_messaging import _channel_managed_env_keys
...
class TestCliWizard:
    """`shellgpt setup gateway` drops the same knobs. Real wizard, scripted
    stdin, real .env writes under a temp SHELLGPT_HOME."""
