...
The oneshot path builds its AIAgent directly (bypassing ShellGPTCLI), so the
...
from shellgpt_cli.oneshot import _build_preloaded_skills_prompt, _normalize_skills
