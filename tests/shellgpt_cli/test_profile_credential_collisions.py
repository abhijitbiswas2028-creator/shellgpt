...
local profile homes was invisible to ``shellgpt doctor`` / ``shellgpt gateway status``; the only signal
...
from shellgpt_cli import doctor_state, gateway, gateway_migrate as gm
