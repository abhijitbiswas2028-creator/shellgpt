...
stale-module ImportError after ``shellgpt update``.
"""
...
import shellgpt_cli.web_routers.models as _rt_models
...
class TestModelSwitchSkewGuard:
    ...
    def test_guard_message_names_revs_and_restart(self, monkeypatch):
        ...
        assert "shellgpt gateway restart" in msg
...
class TestModelOptionsSkewGuard:
    ...
    def test_stale_dashboard_returns_503_and_skips_payload_build(self, monkeypatch):
        ...
        payload_calls: list = []
        monkeypatch.setattr(
            "shellgpt_cli.inventory.build_model_options_payload",
    ...
    def test_fresh_dashboard_builds_payload_unchanged(self, monkeypatch):
        ...
        monkeypatch.setattr("shellgpt_cli.inventory.load_picker_context", lambda: {})
