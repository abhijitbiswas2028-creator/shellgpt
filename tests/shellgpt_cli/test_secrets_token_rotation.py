"""Tests for `shellgpt secrets bitwarden token` / `shellgpt secrets onepassword token`.
...
from shellgpt_cli import onepassword_secrets_cli as op_cli
from shellgpt_cli import secrets_cli as bw_cli
