"""Tests for shellgpt_cli.kanban_diagnostics — rule-engine that produces
...
def test_running_with_open_parents_fires_only_while_running():
    ...
    assert "shellgpt kanban unlink t_parent t_demo00" in diags[0].actions[0].payload["command"]
