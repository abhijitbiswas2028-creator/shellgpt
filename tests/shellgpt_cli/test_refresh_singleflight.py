...
from shellgpt_cli.dashboard_auth import refresh_singleflight as replay
from shellgpt_cli.dashboard_auth.base import ProviderError, RefreshExpiredError, Session
from shellgpt_cli.dashboard_auth.routes import router
...
def test_cookie_gate_burst_with_stale_rt_rotates_once(gated_web_app):
    ...
    cookies = {"shellgpt_session_at": "expired-at", "shellgpt_session_rt": "stale-rt",
               "shellgpt_session_provider": "stub"}
