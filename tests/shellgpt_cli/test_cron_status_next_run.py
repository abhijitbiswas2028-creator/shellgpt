...
from shellgpt_cli.cron import _print_active_jobs_summary
...
def _frozen_clock(monkeypatch):
    ...
    monkeypatch.setattr(job_store, "_shellgpt_now", lambda: now)
    monkeypatch.setattr("shellgpt_time.now", lambda: now)
