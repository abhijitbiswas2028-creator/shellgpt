"""Tests for shellgpt_cli/setup_terminal.py backend wizards."""

import pytest

from shellgpt_cli.config import save_env_value, get_env_value
from shellgpt_cli import setup as setup_mod
from shellgpt_cli import setup_terminal
