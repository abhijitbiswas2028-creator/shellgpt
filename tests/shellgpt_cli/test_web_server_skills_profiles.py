...
import shellgpt_cli.web_server_profiles as _web_server_profiles
...
class TestProfileScopedHubActions:
    def test_hub_install_spawns_with_profile_flag(
        ...
        """Hub installs must go through a fresh ``shellgpt -p <profile>``
        ...
        monkeypatch.setattr(_web_server_gateway, "_spawn_shellgpt_action", _fake_spawn)
        resp = client.post(
