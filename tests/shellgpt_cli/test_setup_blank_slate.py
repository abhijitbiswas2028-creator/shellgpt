"""Tests for Blank Slate setup mode (shellgpt_cli/setup.py).
...
from shellgpt_cli.setup_quick import _blank_slate_minimal_toolsets, _blank_slate_minimize_config
...
class TestBlankSlateFork:
    ...
    def _patch_common(self, monkeypatch):
        import shellgpt_cli.setup as s
