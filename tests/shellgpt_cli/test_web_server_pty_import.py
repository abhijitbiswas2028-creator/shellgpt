"""Test the platform-branched PTY bridge import in shellgpt_cli.web_server_chat.
...
def test_web_server_uses_posix_pty_bridge_on_posix():
    ...
    from shellgpt_cli.pty_bridge import PtyBridge as PosixBridge
    from shellgpt_cli.pty_bridge import PtyUnavailableError as PosixErr
