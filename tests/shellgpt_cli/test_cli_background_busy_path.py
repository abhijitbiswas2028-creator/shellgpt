...
mirroring tests/shellgpt_cli/test_cli_steer_busy_path.py.
"""
...
def _make_cli():
    """Bare ShellGPTCLI (no __init__): the detector only reads _agent_running."""
    from cli import ShellGPTCLI

    return ShellGPTCLI.__new__(ShellGPTCLI)
