...
class TestGetCopilotModelContext:
    ...
    @patch("shellgpt_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("shellgpt_cli.models._urlopen_model_catalog_request")
    ...
    @patch("shellgpt_cli.models.fetch_github_model_catalog", return_value=[])
