...
from cli import ShellGPTCLI, _build_compact_banner, _rich_text_from_ansi
from shellgpt_cli.skin_engine import get_active_skin, set_active_skin
...
class TestCliSkinPromptIntegration:
    ...
    def test_narrow_terminals_compact_voice_recording_prompt_fragments(self):
        ...
        with patch.object(ShellGPTCLI, "_get_tui_terminal_width", return_value=50):
            frags = cli._get_tui_prompt_fragments()
...
class TestCompactBannerSkinIntegration:
    ...
    def test_poseidon_compact_banner_uses_skin_colors(self):
        ...
        with patch("cli.shutil.get_terminal_size", return_value=SimpleNamespace(columns=90)), \
             patch.dict(_build_compact_banner.__globals__, {"format_banner_version_label": lambda: "ShellGPT Agent v0.1.0 (test)"}):
