"""Tests for shellgpt_cli.skin_engine — the data-driven skin/theme system."""
...
class TestSkinManagement:
    def test_set_active_skin(self):
        from shellgpt_cli.skin_engine import set_active_skin, get_active_skin, get_active_skin_name
...
class TestUserSkins:
    def test_load_user_skin_from_yaml(self, tmp_path, monkeypatch):
        from shellgpt_cli.skin_engine import load_skin
        ...
        # Patch skins dir
        monkeypatch.setattr("shellgpt_cli.skin_engine._skins_dir", lambda: skins_dir)
...
class TestDisplayIntegration:
    ...
    def test_tool_message_uses_skin_prefix(self):
        from shellgpt_cli.skin_engine import set_active_skin
...
class TestCliBrandingHelpers:
    ...
    def test_prompt_toolkit_style_overrides_cover_tui_classes(self):
        from shellgpt_cli.skin_engine import set_active_skin, get_prompt_toolkit_style_overrides
        set_active_skin("ares")
