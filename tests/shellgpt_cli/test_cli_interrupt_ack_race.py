...
Root cause: ``ShellGPTCLI.chat()`` fires ``agent.interrupt(msg)`` from its
...
def _make_cli():
    """Build a ShellGPTCLI with prompt_toolkit stubbed (same pattern as
