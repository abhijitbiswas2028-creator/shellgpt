"""Tests for the Speech-to-Text category in `shellgpt tools` (tools_config).
...
from shellgpt_cli.tools_config import (  # noqa: E402
    STT_MODEL_CATALOG,
    TOOL_CATEGORIES,
...
class TestModelPicker:
    ...
    def test_configure_stt_model_defaults_to_current(self):
        ...
        with patch(
            "shellgpt_cli.tools_config._prompt_choice", return_value=0
        ) as pc:
