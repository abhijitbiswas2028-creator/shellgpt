"""Regression test: shellgpt update must not load cryptography eagerly."""
...
assert 'shellgpt_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running shellgpt update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so shellgpt_cli is importable,
