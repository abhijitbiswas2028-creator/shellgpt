"""Tests for the ``shellgpt prompt-size`` diagnostic (issue #34667)."""
...
from shellgpt_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(shellgpt_home, memory_text="", user_text=""):
...
def _seed_skill(shellgpt_home, name, description):
    skill_dir = shellgpt_home / "skills" / "demo" / name
