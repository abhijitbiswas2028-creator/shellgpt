...
import shellgpt_cli.model_switch_providers as shellgpt_cli_model_switch_providers
...
def test_passthrough_kwargs_to_base(monkeypatch):
    ...
    monkeypatch.setattr(shellgpt_cli_model_switch_providers, "list_authenticated_providers", _capture)
    monkeypatch.setattr("shellgpt_cli.models.fetch_openrouter_models",
                        lambda *a, **kw: [])
...
def _stub_kimi_discovery(monkeypatch, *, canonical):
    ...
    import shellgpt_cli.models as hm
    import shellgpt_cli.models_catalog_static as shellgpt_cli_models_catalog_static
    from shellgpt_cli import models_catalog_static
    ...
    monkeypatch.setattr(shellgpt_cli_models_catalog_static, "CANONICAL_PROVIDERS", canonical)
