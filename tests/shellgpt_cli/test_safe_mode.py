"""Tests for `shellgpt chat --safe-mode` isolation."""
...
_VARS = ("SHELLGPT_SAFE_MODE", "SHELLGPT_IGNORE_USER_CONFIG", "SHELLGPT_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["SHELLGPT_SAFE_MODE"] == "1"
        assert os.environ["SHELLGPT_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["SHELLGPT_IGNORE_RULES"] == "1"
        return True
