"""Regression: ``shellgpt update`` should take a managed checkout off autocrlf=true.
...
``shellgpt update`` has to repair them.
...
from shellgpt_cli.update_cmd import _normalize_managed_eol
