...
``SHELLGPT_PORTAL_BASE_URL=https://portal.staging-nousresearch.com`` in its
...
class TestResolveAccessTokenEnvOverrideWins:
    ...
    def test_env_override_wins_even_with_staging_state_stored(
        ...
        a prior SHELLGPT_AUTH_JSON_BOOTSTRAP seed), and the env var is set to
        ...
        monkeypatch.setenv("SHELLGPT_PORTAL_BASE_URL", staging_portal)
