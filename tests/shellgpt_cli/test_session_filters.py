"""Tests for shellgpt_cli.session_filters — CLI time/filter parsing for
`shellgpt sessions prune` / `shellgpt sessions archive`."""
...
from shellgpt_cli.session_filters import (
    build_prune_filters,
