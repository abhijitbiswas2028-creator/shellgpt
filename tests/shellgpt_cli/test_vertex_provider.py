...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (shellgpt_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_shellgpt_overlays():
    """shellgpt_cli.providers.get_provider("vertex") backs
