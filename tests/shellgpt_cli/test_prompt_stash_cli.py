"""Tests for the Ctrl+S prompt stash wiring inside ShellGPTCLI.

The state machine itself is covered by tests/shellgpt_cli/test_prompt_stash.py. These
tests verify the cli.py side:
  - ShellGPTCLI.__init__ creates a PromptStash
...
tests/shellgpt_cli/test_cli_extension_hooks.py.
"""
...
def _make_cli(**kwargs):
    """Create a ShellGPTCLI with prompt_toolkit stubbed out."""
    _clean_config = {
        "model": {
