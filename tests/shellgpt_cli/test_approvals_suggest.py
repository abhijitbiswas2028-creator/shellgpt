"""Tests for ``shellgpt approvals suggest`` (shellgpt_cli/approvals_suggest.py).

Approval history in ShellGPT is implied, not ledgered: the session DB
...
from shellgpt_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
