"""Tests for the shared tar.gz writer (``shellgpt_cli.archive_safe.make_targz``).

``make_targz`` backs both ``shellgpt profile export`` and ``shellgpt kanban
...
from shellgpt_cli.archive_safe import make_targz
