"""Tests for shellgpt_cli.status model/provider display."""

from types import SimpleNamespace

from shellgpt_cli.nous_account import NousPaidServiceAccessInfo, NousPortalAccountInfo
from shellgpt_cli.nous_subscription import NousFeatureState, NousSubscriptionFeatures
import subprocess
...
def test_show_status_reports_empty_lmstudio_listing_as_reachable(monkeypatch, capsys, tmp_path):
    ...
    monkeypatch.setattr(
        "shellgpt_cli.models_local.probe_lmstudio_models",
