"""Regression for #117276: ``shellgpt doctor``'s exit status must agree with its unresolved findings."""
...
def test_doctor_command_reports_remaining_findings(monkeypatch, capsys, issues, manual, fixed, fix, expected):
    ...
    from shellgpt_cli.main import cmd_doctor
