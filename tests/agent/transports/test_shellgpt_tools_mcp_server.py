"""Tests for the shellgpt-tools-as-MCP server module surface.
...
from agent.transports.shellgpt_tools_mcp_server import (
...
class TestMain:
    def test_main_returns_2_when_mcp_unavailable(self, monkeypatch):
        ...
        import agent.transports.shellgpt_tools_mcp_server as m
