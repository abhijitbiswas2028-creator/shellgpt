...
class TestLifecycle:
    ...
    def test_thread_start_carries_shellgpt_prompt_and_disables_codex_personality(self):
        """thread/start carries cwd, ShellGPT' composed prompt as developerInstructions and
...
def test_only_current_turn_progress_reaches_shellgpt_activity_clock():
