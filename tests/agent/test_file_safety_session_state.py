...
manipulation. ShellGPT keeps canonical conversation history in state.db and may
...
def fake_homes(tmp_path, monkeypatch):
    """Point SHELLGPT_HOME at a temp profile dir.

    Uses the real env-var resolution chain (get_shellgpt_home /
    get_default_shellgpt_root) instead of monkeypatching private helpers —
    ...
    SHELLGPT_HOME=<root>/profiles/<name> makes get_default_shellgpt_root()
