...
children via ``shellgpt_cli.fallback_config.scoped_fallback_chain``):
...
def test_resolve_job_runtime_does_not_walk_the_chain_for_a_pinned_job(pin):
    ...
    with patch("shellgpt_cli.runtime_provider.resolve_runtime_provider", resolve):
...
def test_resolve_job_runtime_walks_the_chain_for_an_unpinned_job():
    ...
    with patch("shellgpt_cli.runtime_provider.resolve_runtime_provider", side_effect=resolve):
