...
def make_shellgpt_home(base: Path, journal_mode: str) -> Path:
    """Create an isolated SHELLGPT_HOME whose config pins ``database.journal_mode``.
    ...
    """
    home = base / f"shellgpt-home-{journal_mode}"
