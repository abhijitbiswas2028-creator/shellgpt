...
``load_gateway_config`` against a temp SHELLGPT_HOME — no patched predicates.
"""
import os
...
def profile_homes(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("shellgpt_cli.profiles._get_profiles_root", lambda: home / "profiles")
