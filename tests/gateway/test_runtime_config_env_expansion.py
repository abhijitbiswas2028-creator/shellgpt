...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("SHELLGPT_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("SHELLGPT_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("SHELLGPT_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
