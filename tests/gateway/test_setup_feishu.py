"""Tests for _setup_feishu() in shellgpt_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("shellgpt_cli.config.save_env_value", side_effect=mock_save), \
         patch("shellgpt_cli.config.get_env_value", side_effect=mock_get), \
         patch("shellgpt_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("shellgpt_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("shellgpt_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("shellgpt_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("shellgpt_cli.cli_output.print_header"), \
         patch("shellgpt_cli.cli_output.print_info"), \
         patch("shellgpt_cli.cli_output.print_success"), \
         patch("shellgpt_cli.cli_output.print_warning"), \
         patch("shellgpt_cli.cli_output.print_error"), \
