...
Real profile files under a temp SHELLGPT_HOME, the production startup hook and the
...
SPELLINGS = {
    ...
    "managed": None,  # user YAML absent; disable comes from SHELLGPT_MANAGED_DIR
}
