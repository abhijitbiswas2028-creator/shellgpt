...
def store(tmp_path, monkeypatch):
    ...
    ~/.shellgpt/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at shellgpt_state import time, before pytest's SHELLGPT_HOME monkeypatch
    fires — the autouse fixture's SHELLGPT_HOME override doesn't help here.)
    """
