"""``$SHELLGPT_HOME/cache/<kind>/`` materialisation helpers for the image/video
...
def cache_dir(kind: str) -> Path:
    """Return ``$SHELLGPT_HOME/cache/<kind>/``, creating parents as needed."""
    from shellgpt_constants import get_shellgpt_home
    path = get_shellgpt_home() / "cache" / kind
