...
A host that runs a blocking command on a worker thread (ShellGPT Console) never sees
...
_ACTIVE_SCOPE: ContextVar[Optional["InterruptScope"]] = ContextVar("shellgpt_interrupt_scope", default=None)
