...
plugins should use :func:`canonical_whatsapp_identifier` to line up with ShellGPT' session keys.
"""
...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    if not normalized:
        return set()
    session_dir = get_shellgpt_dir("platforms/whatsapp/session", "whatsapp/session")
