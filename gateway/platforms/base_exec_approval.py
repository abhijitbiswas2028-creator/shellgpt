...
the same three things: what ShellGPT wants to run, why it was flagged, and that silence means
...
EA_HEADER_TEXT = "ShellGPT wants to run a command that needs your OK"
