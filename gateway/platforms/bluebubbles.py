...
# `require_mention: true` without custom aliases uses ShellGPT wake words.
DEFAULT_MENTION_PATTERNS = [r"(?<![\w@])@?shellgpt\s+agent\b[,:\-]?", r"(?<![\w@])@?shellgpt\b[,:\-]?"]
...
class BlueBubblesAdapter(BasePlatformAdapter):
    ...
    def _compile_mention_patterns(raw: Any) -> List[re.Pattern]:
        ...
        comma/newline-separated), or None (ShellGPT defaults)."""
