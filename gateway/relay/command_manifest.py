...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _cmd("reset", "Reset your ShellGPT session"),
        ...
        _cmd("status", "Show ShellGPT session status"),
        _cmd("sethome", "Set this chat as the home channel"),
        _cmd("stop", "Stop the running ShellGPT agent"),
        ...
        _cmd("update", "Update ShellGPT Agent to the latest version"),
        _cmd("restart", "Gracefully restart the ShellGPT gateway"),
        ...
        _cmd("thread", "Create a new thread and start a ShellGPT session in it",
