...
# Openers of ShellGPT' own control frames (agent.prompt_builder.CONTROL_FRAME_OPENERS: the steer marker, the
...
# Genuine user lines are never touched. Keep in sync with apps/desktop shellgpt-bots/group-round-prompt.ts.
