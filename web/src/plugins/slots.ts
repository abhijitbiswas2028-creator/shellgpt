 ...
 * `window.__SHELLGPT_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the ShellGPT brand in the top bar
 ...
 *  `window.__SHELLGPT_PLUGINS__.registerSlot(...)`.
 *
