 ...
 *
 * Plugins call window.__SHELLGPT_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__SHELLGPT_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__SHELLGPT_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__SHELLGPT_PLUGIN_SDK__ = {
    ...
    // window.__SHELLGPT_SESSION_TOKEN__ directly.
    authedFetch,
