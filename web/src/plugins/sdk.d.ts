/**
 * ShellGPT Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__SHELLGPT_PLUGIN_SDK__`` and
 * ``window.__SHELLGPT_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__SHELLGPT_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``ShellGPTPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@shellgpt/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__SHELLGPT_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__SHELLGPT_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__SHELLGPT_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface ShellGPTPluginSDK {
...
declare global {
  interface Window {
    __SHELLGPT_PLUGIN_SDK__?: ShellGPTPluginSDK;
    __SHELLGPT_PLUGINS__?: PluginRegistry;
  }
}
