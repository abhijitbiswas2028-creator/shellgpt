 ...
 *
 * Values come from @shellgpt/shared (shellgpt_constants.VALID_REASONING_EFFORTS
 * plus `none`, thinking-off). An empty/unset config value means the ShellGPT
 * default.
 */
 ...
 *  option. Empty/unknown → `medium` (ShellGPT' default when unset). */
