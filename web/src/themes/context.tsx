...
const STORAGE_KEY = "shellgpt-dashboard-theme";
...
const FONT_STORAGE_KEY = "shellgpt-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `shellgpt_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "shellgpt-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-shellgpt-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-shellgpt-theme-font", "true");
