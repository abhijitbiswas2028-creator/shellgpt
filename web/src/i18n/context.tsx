import { applyDocumentLocale, LOCALE_ENDONYMS } from "@shellgpt/shared/i18n";
...
// Display metadata for the language picker — endonyms from @shellgpt/shared so the
...
const STORAGE_KEY = "shellgpt-locale";
