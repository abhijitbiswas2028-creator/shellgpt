...
The run gets a throwaway SHELLGPT_HOME so no local config leaks in, and the
...
if _or_key:
    ...
    # Resolved by the orchestrator BEFORE SHELLGPT_HOME is redirected to the
