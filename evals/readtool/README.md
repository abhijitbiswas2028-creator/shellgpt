...
benchmarked ten harnesses on hostile-file handling — and whose ShellGPT column
...
Every task runs the full ShellGPT agent (file + terminal + search toolsets)
...
Rules of engagement (from shellgptbench discipline):
