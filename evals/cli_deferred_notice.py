...
def run_case(root, output, name, behind, early=False, cancel=False):
    with tempfile.TemporaryDirectory(prefix="shellgpt_test_notice_") as home:
        ...
        from shellgpt_cli.banner import VERSION
        ...
        bootstrap = ("import shellgpt_cli.main as m; import shellgpt_cli.banner as b; "
        ...
        try:
            ...
            result = {"case": name, "ready": ready, "exited": exited,
                      ...
                      "loaded_worktree": str(root / "shellgpt_cli/banner.py") in text,
