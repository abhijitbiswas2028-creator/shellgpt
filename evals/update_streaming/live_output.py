...
def step(mode):
    from shellgpt_cli.main_dashboard import _install_hangup_protection, _finalize_update_output
    from shellgpt_cli.main import _run_logged_subprocess
