...
Run with the repository's Python and a disposable SHELLGPT_HOME. No provider calls.
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="cron-owned-fork-") as root:
        os.environ["SHELLGPT_HOME"] = root
        os.environ["SHELLGPT_CRON_SCRIPT_TIMEOUT"] = "2"
