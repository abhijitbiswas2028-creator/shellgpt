...
Scratch HOME, SHELLGPT_HOME, Python facade and CLI shims; no user profiles or credentials.
...
(cd apps/desktop && SHELLGPT_DESKTOP_CDP_PORT=off BOT_DM_SERVICE_PATH=1 \
...
worktree-pinned `shellgpt`; PATH contains a different inert `shellgpt` that exits 2
