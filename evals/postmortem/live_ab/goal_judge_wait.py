...
os.environ.setdefault("SHELLGPT_HOME", os.path.expanduser("~/.shellgpt"))  # LIVE: real auxiliary judge calls (cents)
from shellgpt_cli import goals
goal = ("Simplify the shellgpt-agent codebase by >=30% LOC with zero behavior change, decomposing every god file, "
