...
os.environ["SHELLGPT_HOME"] = str(root / ".shellgpt")
from shellgpt_cli import update_cmd_fleet as fleet, update_receipt as receipts
...
try:
    for name in ["alpha", "beta"]:
        home = root / ".shellgpt" / "profiles" / name
    ...
    d = root / ".shellgpt/logs/update_receipts"
    ...
    home = root / ".shellgpt/profiles/beta"
