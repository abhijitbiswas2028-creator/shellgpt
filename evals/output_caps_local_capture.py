...
Run from a checkout with SHELLGPT_HOME pointing to a disposable directory.
"""
import json
import os
...
os.environ["SHELLGPT_MAX_TOKENS"] = "13"
...
from shellgpt_cli.moa_config import _normalize_preset
