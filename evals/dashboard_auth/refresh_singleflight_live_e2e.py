...
os.environ["SHELLGPT_HOME"] = tempfile.mkdtemp(prefix="shellgpt-e2e-55712-")
for m in [k for k in sys.modules if k.startswith(("shellgpt", "tools", "plugins"))]:
    del sys.modules[m]

import uvicorn  # noqa: E402

from shellgpt_cli import web_server  # noqa: E402
from shellgpt_cli.dashboard_auth import register_provider  # noqa: E402
from shellgpt_cli.dashboard_auth.base import RefreshExpiredError, Session  # noqa: E402
from tests.shellgpt_cli.conftest_dashboard_auth import StubAuthProvider  # noqa: E402
...
idp.calls = 0
ck = "shellgpt_session_at=expired-at; shellgpt_session_rt=cookie-stale; shellgpt_session_provider=stub"
with ThreadPoolExecutor(4) as pool:
