...
Built for [ShellGPT Agent](https://github.com/NousResearch/shellgpt-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/shellgpt-agent/skills/creative/ascii-video`](https://github.com/NousResearch/shellgpt-agent/tree/main/skills/creative/ascii-video) via PR.
