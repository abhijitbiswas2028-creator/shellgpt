/**
 * ShellGPT desktop plugin template. Save as:
 *   <shellgpt home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <shellgpt home> is ~/.shellgpt by default, or ~/.shellgpt/profiles/<name>
 * when running a named profile (`shellgpt -p <name>`). Run `shellgpt doctor` (or
 ...
 * Only these imports resolve: @shellgpt/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@shellgpt/plugin-sdk'
