...
Registry of record: `shellgpt_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore ShellGPT config+state snapshots (CLI)
...
/update                  Update ShellGPT to latest
