#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the ShellGPT docs site.
...
LLM reads to learn what ShellGPT does.

Both publish at:
  https://shellgpt-agent.nousresearch.com/docs/llms.txt
  https://shellgpt-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://shellgpt-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use ShellGPT as a Python Library", None),
        ("guides/use-mcp-with-shellgpt", "Use MCP with ShellGPT", None),
        ("guides/use-voice-mode-with-shellgpt", "Use Voice Mode with ShellGPT", None),
        ("guides/use-soul-with-shellgpt", "Use SOUL.md with ShellGPT", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with ShellGPT"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "shellgpt-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/shellgpt-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# ShellGPT Agent — Full Documentation\n",
        (
            "This file is the entire ShellGPT Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using ShellGPT, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://shellgpt-agent.nousresearch.com/docs\n",
        "Short index: https://shellgpt-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
