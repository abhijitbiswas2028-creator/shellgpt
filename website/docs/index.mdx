...
slug: /
sidebar_position: 0
title: "ShellGPT Agent Documentation"
...
After installing, run `shellgpt setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](./integrations/nous-portal.md).
:::

## What is ShellGPT Agent?
...
| 🔌 **[MCP Integration](./user-guide/features/mcp.md)**                      | Connect to MCP servers, filter their tools, and extend ShellGPT safely  |
| 🧭 **[Use MCP with ShellGPT](./guides/use-mcp-with-shellgpt.md)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](./user-guide/features/voice-mode.md)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with ShellGPT](./guides/use-voice-mode-with-shellgpt.md)** | Hands-on setup and usage patterns for ShellGPT voice workflows          |
| 🎭 **[Personality & SOUL.md](./user-guide/features/personality.md)**        | Define ShellGPT' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](./guides/tips.md)**                            | Quick wins to get the most out of ShellGPT                              |
...
- **Built by model trainers** — Created by [Nous Research](https://nousresearch.com), the lab behind ShellGPT, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nous Research](https://nousresearch.com) — the lab behind ShellGPT, Nomos, and Psyche models
