...
| [`shellgpt-agent`](../user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-shellgpt-agent.md) | Use, configure, theme, extend, and orchestrate ShellGPT Agent. | `autonomous-ai-agents/shellgpt-agent` |
...
| [`shellgpt-agent-skill-authoring`](../user-guide/skills/bundled/software-development/software-development-shellgpt-agent-skill-authoring.md) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/shellgpt-agent-skill-authoring` |
| [`inspecting-shellgpt-desktop-dom`](../user-guide/skills/bundled/software-development/software-development-inspecting-shellgpt-desktop-dom.md) | Read the live ShellGPT desktop DOM/CSS over CDP. | `software-development/inspecting-shellgpt-desktop-dom` |
