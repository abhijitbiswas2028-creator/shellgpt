...
description: "How the ShellGPT Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the ShellGPT Desktop app connects to a **gated gateway** (a hosted or
...
For ShellGPT specifically, native sign-in means:
...
- [Run ShellGPT with Nous Portal](./run-shellgpt-with-nous-portal.md)
