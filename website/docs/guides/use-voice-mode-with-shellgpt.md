---
sidebar_position: 8
title: "Use Voice Mode with ShellGPT"
description: "A practical guide to setting up and using ShellGPT voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with ShellGPT
...
- you want ShellGPT sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in ShellGPT.
...
## Step 1: make sure normal ShellGPT works first
...
ShellGPT supports both local and cloud speech stacks.
...
4. ShellGPT transcribes and responds
...
- asking ShellGPT to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full ShellGPT loop.

## Tuning CLI behavior

### Silence threshold

If ShellGPT starts/stops too aggressively, tune:
...
ShellGPT stays a normal chat bot, but can speak replies.
...
- you want ShellGPT to function like a portable research or ops assistant
...
ShellGPT joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- ShellGPT detects speech boundaries
- transcripts are posted in the associated text channel
- ShellGPT responds in text and audio
...
1. get text ShellGPT working
2. run `shellgpt setup tts` to enable voice support
