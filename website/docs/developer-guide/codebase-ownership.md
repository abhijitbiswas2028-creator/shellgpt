...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `shellgpt_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `shellgpt_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a ShellGPT Plugin](plugins/index.md) |
...
| Session storage | `shellgpt_state.py`, `shellgpt_state_*.py` | [Session Storage](session-storage.md) |
