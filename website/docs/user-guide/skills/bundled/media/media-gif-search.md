...
Set your Tenor API key in your environment (add to `${SHELLGPT_HOME:-~/.shellgpt}/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/NousResearch/shellgpt-agent/blob/main/skills/media/gif-search/url)`
