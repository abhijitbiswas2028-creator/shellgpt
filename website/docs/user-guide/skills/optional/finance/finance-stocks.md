...
| | |
|---|---|
| Source | Optional — install with `shellgpt skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), ShellGPT Agent |
| License | MIT |
...
```
python ~/.shellgpt/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
