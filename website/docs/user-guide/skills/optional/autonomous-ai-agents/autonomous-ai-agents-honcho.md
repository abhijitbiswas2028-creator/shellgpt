---
title: "Honcho — Configure and troubleshoot Honcho memory for ShellGPT"
...
Configure and troubleshoot Honcho memory for ShellGPT.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `shellgpt skills install official/autonomous-ai-agents/honcho` |
