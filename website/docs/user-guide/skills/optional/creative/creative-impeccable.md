...
| | |
|---|---|
| Source | Optional — install with `shellgpt skills install official/creative/impeccable` |
...
> ships and verifies a ShellGPT-native skill bundle under `.shellgpt/skills/`.
> `shellgpt skills install impeccable` pulls the current bundle live from that
