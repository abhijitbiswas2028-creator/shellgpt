...
| | |
|---|---|
| Source | Optional — install with `shellgpt skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain/solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by ShellGPT Agent |
| License | MIT |
...
Helper script path: ~/.shellgpt/skills/blockchain/solana/scripts/solana_client.py
...
python ~/.shellgpt/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.shellgpt/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.shellgpt/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.shellgpt/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.shellgpt/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.shellgpt/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
