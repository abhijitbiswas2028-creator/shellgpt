...
| | |
|---|---|
| Source | Optional — install with `shellgpt skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), ShellGPT Agent |
| License | MIT |
...
The script reads `${SHELLGPT_HOME:-~/.shellgpt}/.env` for two optional defaults:
...
Helper script: `~/.shellgpt/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python ~/.shellgpt/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${SHELLGPT_HOME:-~/.shellgpt}/.env`.
...
```bash
python ~/.shellgpt/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.shellgpt/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
