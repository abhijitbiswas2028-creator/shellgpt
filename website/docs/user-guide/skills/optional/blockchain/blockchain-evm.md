...
| | |
|---|---|
| Source | Optional — install with `shellgpt skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), ShellGPT Agent |
| License | MIT |
...
Helper script path: `~/.shellgpt/skills/blockchain/evm/scripts/evm_client.py`
...
python ~/.shellgpt/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python ~/.shellgpt/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
