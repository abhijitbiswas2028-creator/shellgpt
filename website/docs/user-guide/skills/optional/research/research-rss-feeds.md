...
| | |
|---|---|
| Source | Optional — install with `shellgpt skills install official/research/rss-feeds` |
...
`python3 scripts/feed.py read https://github.com/NousResearch/shellgpt-agent/releases.atom
