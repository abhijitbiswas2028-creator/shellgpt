...
| | |
|---|---|
| Source | Optional — install with `shellgpt skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | ShellGPT Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $SHELLGPT_OSINT_CACHE/icij/ (default: ~/.cache/shellgpt-osint/icij/).
...
# Set SHELLGPT_OSINT_UA=your-app/1.0 (your@email) to identify yourself
