...
| | |
|---|---|
| Source | Optional — install with `shellgpt skills install official/research/blogwatcher` |
...
## Working with ShellGPT tools (read this first)

`blogwatcher-cli` is the feed database; ShellGPT tools do the automation around it:
