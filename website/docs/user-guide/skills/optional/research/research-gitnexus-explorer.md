...
| | |
|---|---|
| Source | Optional — install with `shellgpt skills install official/research/gitnexus-explorer` |
...
| Related skills | [`shellgpt-agent`](../../bundled/autonomous-ai-agents/autonomous-ai-agents-shellgpt-agent.md), [`codebase-inspection`](../../bundled/software-development/software-development-codebase-inspection.md) |
...
- **The web UI does NOT create `.claude/` or `CLAUDE.md`.** Those are created by
  ...
  shellgpt-agent users don't need.
