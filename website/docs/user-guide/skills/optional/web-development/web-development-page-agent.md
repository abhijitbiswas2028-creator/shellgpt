...
| | |
|---|---|
| Source | Optional — install with `shellgpt skills install official/web-development/page-agent` |
...
- User wants **ShellGPT itself to drive a browser** → use ShellGPT' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
