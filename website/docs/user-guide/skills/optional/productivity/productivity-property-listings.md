...
| | |
|---|---|
| Source | Optional — install with `shellgpt skills install official/productivity/property-listings` |
...
Present researched properties as browsable cards in the ShellGPT desktop transcript.
...
- A ShellGPT desktop conversation for native cards; the backend may be local or remote.
...
```text
shellgpt skills install official/productivity/property-listings
```
