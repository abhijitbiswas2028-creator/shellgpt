...
| | |
|---|---|
| Source | Optional — install with `shellgpt skills install official/productivity/canvas` |
...
4. Name the token (e.g., "ShellGPT Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${SHELLGPT_HOME:-~/.shellgpt}/.env`:
