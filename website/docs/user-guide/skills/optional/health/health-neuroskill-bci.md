...
| | |
|---|---|
| Source | Optional — install with `shellgpt skills install official/health/neuroskill-bci` |
...
Connect ShellGPT to a running [NeuroSkill](https://neuroskill.com/) instance to read
