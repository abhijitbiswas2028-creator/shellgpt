#!/usr/bin/env python3
"""Build the ShellGPT Skills Index — a centralized JSON catalog of all skills.
...
`shellgpt skills search/install` can use it without hitting the GitHub API.
...
# Ensure SHELLGPT_HOME is set (needed by tools/skills_hub*.py imports)
...
def main():
    print("Building ShellGPT Skills Index...", flush=True)
