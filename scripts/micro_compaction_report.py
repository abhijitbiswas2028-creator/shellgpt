#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from ShellGPT logs.
...
With no LOGFILE, reads ``$SHELLGPT_HOME/logs/agent.log`` (default ~/.shellgpt).
...
def default_log() -> Path:
    home = os.environ.get("SHELLGPT_HOME") or str(Path.home() / ".shellgpt")
