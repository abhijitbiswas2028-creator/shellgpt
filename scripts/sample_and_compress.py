...
DEFAULT_DATASETS = [
    ...
    "NousResearch/shellgpt-agent-megascience-sft1",
    "NousResearch/ShellGPT-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/ShellGPT-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-shellgpt-agent"
]
