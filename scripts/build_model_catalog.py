#!/usr/bin/env python3
"""Build the ShellGPT Model Catalog — a centralized JSON manifest of curated models.
...
ShellGPT CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a ShellGPT release.
...
# Ensure SHELLGPT_HOME is set for imports that touch it at module level.
os.environ.setdefault("SHELLGPT_HOME", os.path.join(os.path.expanduser("~"), ".shellgpt"))

from shellgpt_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "shellgpt-agent repo",
            "docs": "https://shellgpt-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model ShellGPT '
