...
def main() -> None:
    ...
    shellgpt_home = Path(tempfile.mkdtemp(prefix="shellgpt-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "shellgpt-gateway-smoke",
    ...
    print(json.dumps({"shellgpt_home": str(shellgpt_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
