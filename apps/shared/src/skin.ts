/**
 * Canonical ShellGPT skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$SHELLGPT_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`shellgpt_cli/skin_engine.py`),
 ...
 *   • CLI     → `shellgpt_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
