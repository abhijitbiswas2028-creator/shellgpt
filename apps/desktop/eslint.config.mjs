...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @shellgpt/plugin-sdk (+ react), never `@/…`
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@shellgpt/shared'],
              message: 'Plugins import only @shellgpt/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
