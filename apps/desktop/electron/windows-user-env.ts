...
// even though a fresh shell — and the ShellGPT CLI — sees it immediately. The
// desktop's SHELLGPT_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\shellgpt. Reading
...
//       SHELLGPT_HOME    REG_SZ    F:\ShellGPT\data
//
