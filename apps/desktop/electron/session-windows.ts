...
// by main.ts (`setBackgroundThrottling` driven by the merged `shellgpt:active-work`
...
// (the "ShellGPT idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey ShellGPT" wake word has NO preceding click,
