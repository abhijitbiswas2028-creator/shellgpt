 ...
 *     it via `shellgpt:profile:remember` without re-homing the primary.
 ...
 * the same SHELLGPT_HOME. That duplicate held a pool slot and starved every other
...
export class PrimaryProfilePin {
  ...
  /** Called by startShellGPT() with the profile the primary is launching as. */
