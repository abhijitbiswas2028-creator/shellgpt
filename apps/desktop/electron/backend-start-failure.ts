 ...
 * startShellGPT() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startShellGPT() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startShellGPT`, re-emits
