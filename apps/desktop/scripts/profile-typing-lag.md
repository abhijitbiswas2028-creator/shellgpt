...
cd apps/desktop
XCURSOR_SIZE=24 SHELLGPT_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=$HOME/.shellgpt/cache/scratch/shellgpt-typing
# → ~/.shellgpt/cache/scratch/shellgpt-typing.cpuprofile  (open in Chrome DevTools Performance)
# → ~/.shellgpt/cache/scratch/shellgpt-typing.before.heapsnapshot
# → ~/.shellgpt/cache/scratch/shellgpt-typing.after.heapsnapshot
```
