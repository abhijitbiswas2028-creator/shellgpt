...
import { listAllProfileSessions, listSidebarSessions, type SessionInfo } from '@/shellgpt'
...
// dispatcher workers are read on the board, finite one-shot runs (`shellgpt -z`,
