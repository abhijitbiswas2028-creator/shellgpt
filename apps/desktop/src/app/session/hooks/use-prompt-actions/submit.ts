import type { PromptSubmitResult } from '@shellgpt/shared'
import { type MutableRefObject, useCallback } from 'react'

import { PROMPT_SUBMIT_REQUEST_TIMEOUT_MS } from '@/shellgpt'
    ...
    async (rawText: string, options?: SubmitTextOptions) => {
      ...
      try {
        ...
        const submitParams = (targetId: string) => ({
          ...
          // rather than at ShellGPT. The gateway turns this into a per-turn hint
