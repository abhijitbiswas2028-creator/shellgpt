...
export const SETTINGS_MANIFEST = {
  appearance: {
    ...
    minimizeToTray: {
      ...
      available: () => Boolean(window.shellgptDesktop?.minimizeToTray),
  ...
  keybinds: {
    hudModifier: {
      ...
      available: () => Boolean(window.shellgptDesktop?.hudModifier),
    ...
    screenshot: {
      ...
      available: () => Boolean(window.shellgptDesktop?.screenshot),
