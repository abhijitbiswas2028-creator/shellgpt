...
const desktopWindow = window as unknown as { shellgptDesktop: unknown }
const originalBridge = desktopWindow.shellgptDesktop
...
afterEach(() => {
  ...
  desktopWindow.shellgptDesktop = originalBridge
})
