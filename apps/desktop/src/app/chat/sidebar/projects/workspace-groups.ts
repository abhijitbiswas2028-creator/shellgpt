...
import type { ProjectInfo, SessionInfo } from '@/shellgpt'
 ...
 * repo shows its branches/worktrees even when they have no ShellGPT sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: ShellGPTGitWorktree[]
): SidebarSessionGroup[] {
