...
import type { ShellGPTGitBranch } from '@/global'
...
const branchActionLabel = (branch: ShellGPTGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<ShellGPTGitBranch[]>([])
  ...
  const convert = async (branch: ShellGPTGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
