...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/shellgpt'
...
const VERSION = 3
const PREFIX = 'HML' // "ShellGPT Memory Loadout" — namespaces our codes like WoW's leading bytes.
