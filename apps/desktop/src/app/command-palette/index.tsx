...
import { getShellGPTConfigRecord, listAllProfileSessions } from '@/shellgpt'
...
// ShellGPT session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
...
function CommandPaletteBody({ onExited }: { onExited: () => void }) {
  ...
  const configQuery = useQuery({
    ...
    queryFn: () => getShellGPTConfigRecord()
  })
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-shellgpt',
            keywords: ['update', 'upgrade', 'shellgpt', 'version', 'system', 'restart'],
            label: cc.updateShellGPT,
