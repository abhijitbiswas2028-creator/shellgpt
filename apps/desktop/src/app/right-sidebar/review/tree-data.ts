import type { ShellGPTReviewFile } from '@/global'
...
export function buildReviewFlatList(files: ShellGPTReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: ShellGPTReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
