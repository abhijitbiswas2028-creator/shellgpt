...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|shellgpt):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.shellgptDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.shellgptDesktop?.openExternal?.(href)
  }
}
 ...
 * doesn't cost a context switch out of ShellGPT, and it is the surface the agent
