/**
 * The curated ShellGPT plugin catalog as the Desktop sees it.
 *
 ...
 * `plugin-catalog/` directory at site build). A `shellgpt://plugin/install?catalog=<name>`
...
export const CATALOG_ORIGIN = 'https://shellgpt-agent.nousresearch.com'
