import type { ModelCapabilities, ModelOptionProvider, ModelOptionsResult } from '@shellgpt/shared'

import { getGlobalModelOptions, type ShellGPTGateway } from '@/shellgpt'
