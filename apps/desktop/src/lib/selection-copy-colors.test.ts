...
describe('installSelectionCopyColorGuard', () => {
  beforeEach(() => {
    document.documentElement.dataset.shellgptMode = 'dark'
  })

  afterEach(() => {
    delete document.documentElement.dataset.shellgptMode
    window.getSelection()?.removeAllRanges()
  })
  ...
  it('leaves light-ink selections alone when the theme is light', () => {
    document.documentElement.dataset.shellgptMode = 'light'
