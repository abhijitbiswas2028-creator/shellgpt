...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/shellgpt-agent')).toBe('~/www/shellgpt-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/shellgpt-agent')).toBe('shellgpt-agent')
    expect(pathLeaf('~/www/shellgpt-agent')).toBe('shellgpt-agent')
