import type { ToolLabel } from '@shellgpt/shared'
...
import type { SessionMessage, StoredToolCallLabels } from '@/types/shellgpt'
 ...
 * emits one constant id for every call and ShellGPT' own deterministic ids
...
export function applyStoredToolResultToParts(
  ...
  // Tool-call ids are not unique across turns (llama.cpp/ShellGPT reuse them),
