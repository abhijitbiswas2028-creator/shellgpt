import { DEFAULT_REASONING_EFFORT, isReasoningEffort, type ReasoningEffort } from '@shellgpt/shared'
...
/**
 * A pick the route does not send verbatim: `ultra` is a ShellGPT-internal step
 ...
 *  never presents a ShellGPT step as a wire level the route does not have. */
