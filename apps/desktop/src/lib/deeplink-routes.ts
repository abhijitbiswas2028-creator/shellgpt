...
export type DeepLinkAction =
  ...
  /** `shellgpt://plugin/install?catalog=<name>` — resolved against the curated
...
export function resolveDeepLinkAction(payload: DeepLinkPayload | null | undefined): DeepLinkAction {
  ...
  // The browser leg of a connection came back (shellgpt://connections/done?op=…&status=…). The op id
