...
export const de = defineLocale({
  ...
  connectors: {
    ...
    disclaimer: 'Das Verbinden ist freiwillig. Geben Sie nur den Apps Zugriff, die ShellGPT verwenden soll.',
  ...
  connectorsPage: {
    ...
    page: {
      ...
      noMatchBody: 'Keine Treffer. Verweisen Sie ShellGPT auf Ihren eigenen MCP-Server, um ihn hinzuzufügen.',
      ...
      disconnectNoAccount:
        'ShellGPT hat hier kein Konto zum Trennen. Aktualisieren Sie die Seite und versuchen Sie es erneut.',
      disconnectRefused:
    ...
    dialog: {
      ...
      disconnectBody: 'ShellGPT handelt nicht mehr über dieses Konto. Sie können sich jederzeit wieder verbinden.',
      ...
      appSwitch: (name: string) => `ShellGPT darf ${name} verwenden`,
      ...
      wayHosted: 'Verwaltet',
      bothOn: (name: string) => `Beide sind an, daher sieht ShellGPT jedes ${name}-Tool doppelt.`,
      ...
      rulesSignIn: 'Melden Sie sich an, um festzulegen, was ShellGPT hier darf.',
    ...
    tools: {
      ...
      summaryTitle: (name: string) => `Was ShellGPT mit ${name} tun darf`,
      summaryPreviewTitle: (name: string) => `Was ShellGPT mit ${name} tun könnte, sobald Sie verbunden sind`,
      ...
      goneBody:
        'ShellGPT kann ihn nicht mehr aufrufen. Die Zeile bleibt, bis Sie sie entfernen, damit nichts verschwindet.',
      remove: 'Entfernen',
  ...
  sessionImport: {
    ...
    subtitle: 'Holen Sie eine Konversation in ShellGPT und machen Sie dort weiter, wo Sie aufgehört haben.',
    ...
    chooseHelp: 'Wählen Sie eine Session, um ihren Verlauf zu lesen, bevor Sie sie in ShellGPT übernehmen.',
    ...
    you: 'Sie',
    snapshot: 'Diese Konversation ist bereits in ShellGPT. Öffnen Sie Ihre vorhandene Kopie, um weiterzumachen.',
    copyNotice:
    ...
    open: 'In ShellGPT öffnen',
    continue: 'In ShellGPT fortfahren',
  ...
  boot: {
    ready: 'ShellGPT Desktop ist bereit',
    ...
    steps: {
      ...
      loadingSettings: 'ShellGPT-Einstellungen werden geladen',
      loadingSessions: 'Letzte Sessions werden geladen',
      retryingRemoteBackend: 'Wird mit dem Remote-ShellGPT-Backend neu verbunden…',
      startingDesktopConnection: 'Desktop-Verbindung wird gestartet',
      startingShellGPTDesktop: 'ShellGPT Desktop wird gestartet…'
    },
    errors: {
      backgroundExited: 'Der ShellGPT-Hintergrundprozess wurde beendet.',
      backgroundExitedDuringStartup: 'Der ShellGPT-Hintergrundprozess wurde während des Starts beendet.',
      backendStopped: 'Backend gestoppt',
      restartShellGPT: 'ShellGPT neu starten',
      openLogs: 'Logs öffnen',
    ...
    causes: {
      exitedEarly: 'Der Hintergrunddienst von ShellGPT hat direkt nach dem Start aufgehört.',
      timedOut: 'Der Hintergrunddienst von ShellGPT hat nicht rechtzeitig geantwortet.',
      permission: 'ShellGPT konnte nicht in seinen Datenordner schreiben (Berechtigungsproblem).',
      diskFull: 'Die Festplatte ist voll, deshalb konnte ShellGPT nicht starten.',
      portInUse: 'Ein anderes Programm verwendet den Netzwerkport, den ShellGPT braucht.',
      installMissing:
        'Ein Teil der ShellGPT-Installation fehlt. Wählen Sie „Installation reparieren“, um sie wiederherzustellen.'
    },
    failure: {
      title: 'ShellGPT konnte nicht gestartet werden',
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Ihr ShellGPT-Backend ist älter als dieser Desktop-Build und funktioniert möglicherweise nicht richtig. Aktualisieren Sie, um beide abzugleichen.',
    installMethodUnsupportedTitle: 'Nicht unterstützte Installationsmethode',
    updateShellGPT: 'ShellGPT aktualisieren',
    ...
    errors: {
      ...
      storageFailure:
        'ShellGPT konnte nicht in seinen Datenordner speichern. Öffnen Sie die Wartung, um das Problem zu prüfen und zu beheben.',
      gatewayAuthFailed: 'Gateway-Authentifizierung fehlgeschlagen – überprüfen Sie Ihren API_SERVER_KEY.',
      methodNotAllowed:
        'Das Desktop-Backend hat diese Anfrage abgelehnt (405 Method Not Allowed). Starten Sie ShellGPT Desktop neu.',
      ...
      restartShellGPTFailed: 'ShellGPT konnte nicht neu gestartet werden'
    },
    actions: {
      restartShellGPT: 'ShellGPT neu starten',
    ...
    voice: {
      ...
      liveDelegationFailed: 'Anfrage konnte nicht an ShellGPT übergeben werden',
    ...
    native: {
      ...
      inputBody: 'ShellGPT wartet auf Ihre Antwort.',
      turnDoneTitle: 'ShellGPT fertig',
      turnDoneBody: '',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'Sie können auch `shellgpt debug share --nous` im Terminal ausführen oder `shellgpt debug share --local`, um den Bericht ohne Hochladen auszugeben.',
  ...
  settings: {
    ...
    resetConfirm: 'Alle Einstellungen auf ShellGPT-Standard zurücksetzen?',
    ...
    plugins: {
      ...
      installModal: {
        ...
        catalogPinned: (name, sha) =>
          `ShellGPT-Katalog-Eintrag „${name}" — die Agent-Komponente wird am geprüften Pin installiert${sha ? ` ${sha}` : ''}, nicht an der Spitze des Branches.`,
    ...
    vault: {
      ...
      otpHint:
        'Der „Einrichtungsschlüssel", den die Seite beim Aktivieren von 2FA anzeigt. Ist er gespeichert, erzeugt ShellGPT die Codes selbst.',
      ...
      sources: {
        ...
        notInstalled: name =>
          `Nicht erkannt. Installieren Sie das ${name}-Kommandozeilenwerkzeug und melden Sie sich dort an; ShellGPT erkennt es automatisch.`,
        disabledDesc: 'Erkannt, aber für ShellGPT ausgeschaltet.',
        lockedDesc:
          'Erkannt. Der Agent bittet Sie, ihn zu entsperren, wenn er einen Login braucht – oder entsperren Sie ihn jetzt.',
        unlockedDesc:
          'Für diese Session entsperrt. Sperrt automatisch nach 30 Minuten Inaktivität oder wenn ShellGPT geschlossen wird.',
    ...
    notifications: {
      ...
      focusedHint: 'Abschluss-Alerts feuern nur, während ShellGPT im Hintergrund ist.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Eingabe nötig',
          description: 'ShellGPT hat eine Frage gestellt oder braucht ein Passwort oder Geheimnis.'
        },
        turnDone: {
          label: 'Antwort bereit',
          description: 'Ein Turn wurde beendet, während ShellGPT im Hintergrund war.'
        },
        turnError: {
        ...
        plugin: {
          ...
          description: 'Ein Desktop-Plugin hat eine Benachrichtigung gesendet, während ShellGPT im Hintergrund war.'
        }
      },
    ...
    appearance: {
      ...
      colorMode: 'Farbmodus',
      colorModeDesc: 'Wählen Sie einen festen Modus oder lassen Sie ShellGPT Ihrer Systemeinstellung folgen.',
      ...
      reactionsDesc:
        'Emoji-Tapbacks im iMessage-Stil – reagieren Sie auf Nachrichten, und ShellGPT kann auf Ihre reagieren.',
      tipsTitle: 'In-App-Tipps',
      tipsDesc:
        'Eine kleine Blase, die auf einen Teil der App zeigt und gelegentlich im Leerlauf sowie von ShellGPT erscheint, wenn es hilft. Beim Schließen wird sie für immer ausgeblendet.',
      tipsReset: (count: number) => `${count} geschlossene ${count === 1 ? 'Blase' : 'Blasen'} zurückholen`,
      toursTitle: 'Geführte Touren',
      toursDesc:
        'Lassen Sie sich von ShellGPT durch die App führen – der Bildschirm wird abgedunkelt und jeder Schritt hervorgehoben.',
      ...
      pet: {
        title: 'Haustier',
        intro:
          'Adoptieren Sie ein animiertes Petdex-Maskottchen, das über der App schwebt und darauf reagiert, was ShellGPT gerade tut – es rennt, während Tools laufen, feiert bei Erfolg und schmollt bei Fehlern.',
        restartHint:
          'Haustiere erfordern einen kurzen Neustart – die laufende App wurde gestartet, bevor diese Funktion hinzugefügt wurde. Schließen Sie ShellGPT, öffnen Sie es erneut und kehren Sie dann hierher zurück.',
        scaleTitle: 'Größe',
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      fileReadMaxChars: 'Maximale Zeichenzahl, die ShellGPT aus einer Dateianfrage lesen kann.',
      approvals: {
        mode: 'Wie ShellGPT Befehle behandelt, die eine explizite Genehmigung benötigen.',
      ...
      voice: {
        ...
        voiceChatMode:
          'chained: Sprache zu Text → ShellGPT → Text zu Sprache mit den Anbietern unten. gpt-live: Ein Vollduplex-Sprachmodell von OpenAI (gpt-live-1) hört zu und spricht und übergibt jede echte Anfrage an ShellGPT – das von Ihnen gewählte Modell antwortet mit allen Tools. Erfordert einen OpenAI-API-Schlüssel; die Sprachschicht kostet 0,05 $ pro Minute.',
        gptLive: {
          voice: 'Stimme für den GPT-Live-Modus. Eigene Stimm-IDs werden akzeptiert.',
          instructions:
            'Zusätzliche Sätze für die Live-Sprachpersona (Ton, Tempo, Sprache). ShellGPT behält seinen eigenen System-Prompt.'
        }
      },
      tts: {
        xai: {
      ...
      updates: {
        nonInteractiveLocalChanges:
          'Wenn ShellGPT sich aus der App selbst aktualisiert (ohne Terminal-Aufforderung), lokale Quellcode-Änderungen behalten (stash) oder verwerfen (discard). Terminal-Updates fragen immer nach.'
      }
    }),
    uninstallSection: {
      dangerZone: 'Gefahrenzone',
      checkingInstalled: 'Installierte Komponenten werden geprüft…',
      uninstallShellGPT: 'ShellGPT deinstallieren',
      chooseHowMuch:
      ...
      options: {
        gui: {
          ...
          description:
            'Entfernt diese Desktop-App. Der ShellGPT-Agent, Ihre Konfiguration und Ihre Chats bleiben erhalten.',
          consequence: 'die Desktop-Chat-Oberfläche (diese App und ihre Daten)'
        },
        lite: {
          title: 'Oberfläche + Agent deinstallieren, Daten behalten',
          description:
            'Entfernt die App und den ShellGPT-Agent, behält aber Konfiguration, Chats und Geheimnisse für eine spätere Neuinstallation.',
          consequence:
            'die Chat-Oberfläche und den ShellGPT-Agent (Konfiguration, Chats und Geheimnisse bleiben erhalten)'
        },
        full: {
          ...
          consequence:
            'ALLES – die Chat-Oberfläche, den ShellGPT-Agent sowie Ihre gesamte Konfiguration, Chats, Geheimnisse und Logs'
        }
      }
    },
    poolLimits: {
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'ShellGPT sucht im Hintergrund automatisch nach Updates und meldet sich, wenn eines bereit ist.',
    ...
    config: {
      ...
      minimizeToTrayDesc:
        'Beim Minimieren von Fenstern oder Schließen des Hauptfensters werden diese im Infobereich (Menüleiste unter macOS) ausgeblendet und ShellGPT läuft weiter. Beenden Sie über „ShellGPT beenden“ im Infobereich-Menü oder mit Cmd+Q. Standardmäßig aus; gilt nur für dieses Gerät.',
      ...
      loading: 'ShellGPT-Konfiguration wird geladen...',
    ...
    hudModifier: {
      ...
      permission:
        'Erlauben Sie ShellGPT unter Systemeinstellungen → Datenschutz & Sicherheit → Eingabeüberwachung und versuchen Sie es erneut. Diese Geste zeichnet keine Tastenanschläge auf und nimmt Ihren Bildschirm nicht auf.',
      unavailable:
        'Das Hilfsprogramm für die HUD-Geste konnte nicht starten oder wurde unerwartet beendet. Versuchen Sie es erneut oder starten Sie ShellGPT neu. Das bestehende HUD-Tastenkürzel funktioniert innerhalb von ShellGPT weiterhin.',
      missingHelper:
        'In dieser ShellGPT-Installation fehlt das Hilfsprogramm für die HUD-Geste. Aktualisieren oder installieren Sie ShellGPT neu und versuchen Sie es erneut.',
      unsupportedSession:
    ...
    screenshot: {
      ...
      inputPermission:
        'Mit der Berechtigung „Eingabeüberwachung“ kann ShellGPT beide Befehlstasten erkennen, während eine andere App aktiv ist. Erlauben Sie ShellGPT unter Systemeinstellungen → Datenschutz & Sicherheit → Eingabeüberwachung, kehren Sie dann hierher zurück und versuchen Sie es erneut.',
      screenPermission:
        'Mit der Berechtigung „Bildschirmaufnahme“ kann ShellGPT das vorderste App-Fenster aufnehmen, wenn Sie diesen Kurzbefehl verwenden. Erlauben Sie ShellGPT unter Systemeinstellungen → Datenschutz & Sicherheit → Bildschirmaufnahme, kehren Sie dann hierher zurück und versuchen Sie es erneut. Starten Sie ShellGPT neu, wenn macOS dazu auffordert.',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Öffnen Sie mit einem globalen Tastaturkürzel von überall einen kleinen Eingabebereich und senden Sie einen Prompt, ohne ShellGPT zu öffnen.',
    ...
    connections: {
      ...
      intro:
        'Verwalten Sie dieses Gerät und jedes ShellGPT Gateway, das es über Remote-, SSH- oder Cloud-Verbindungen erreichen kann.',
      stagedNote:
      ...
      updateSkippedCloud: 'Wird von ShellGPT Cloud verwaltet',
      kindLocal: 'Lokal',
      kindRemote: 'Remote-Gateway',
      kindCloud: 'ShellGPT Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'Die ShellGPT-Laufzeitumgebung, die von dieser App verwaltet wird.',
      kindRemoteDesc: 'Ein ShellGPT Gateway, das über HTTP(S) erreichbar ist – LAN, Tailscale oder das Internet.',
      kindCloudDesc: 'Eine gehostete Instanz, die über Ihr ShellGPT-Cloud-Konto gefunden wurde.',
      kindSshDesc: 'Eine ShellGPT-Installation, die über SSH erreicht wird.',
      labelTitle: 'Name',
      labelDesc:
      ...
      headersDesc:
        'Wird mit jeder HTTP- und WebSocket-Anfrage an dieses Gateway gesendet – für Zugriffs-Proxys wie Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Werte werden verschlüsselt gespeichert. Header, die ShellGPT verwaltet (Authorization, Cookie, Host…), werden ignoriert.',
      ...
      cloudAddHint:
        'Tipp: Die Anmeldung unter ShellGPT Cloud oben erkennt Ihre Agents automatisch – verwenden Sie dieses Formular nur, um eine bekannte Instanz-URL manuell zu registrieren.',
    ...
    gateway: {
      ...
      intro:
        'Standardmäßig lokal. Verwenden Sie Remote, wenn diese App ein ShellGPT-Backend an einem anderen Ort steuern soll. Gateway-Verbindungen gelten pro Gerät; Profile werden von den Gateways ermittelt, mit denen Sie sich verbinden.',
      envOverrideTitle: 'Umgebungsvariablen steuern diese Desktop-Session.',
      envOverrideDesc:
        'Entfernen Sie SHELLGPT_DESKTOP_REMOTE_URL und SHELLGPT_DESKTOP_REMOTE_TOKEN, um die unten gespeicherte Einstellung zu verwenden.',
      modeTitle: 'Verbindungsmodus',
      localTitle: 'Lokales Gateway',
      localDesc: 'Startet ein privates ShellGPT-Backend auf localhost. Das ist der Standard und funktioniert offline.',
      remoteTitle: 'Remote-Gateway',
      remoteDesc: 'Verbindet diese Desktop-Shell mit einem entfernten ShellGPT-Backend.',
      remoteAuthHint:
      ...
      cloudDesc:
        'Melden Sie sich einmal bei ShellGPT Cloud an und wählen Sie aus den Agents in Ihrem Konto – ohne eine URL einzufügen.',
      cloudSignInTitle: 'ShellGPT Cloud',
      cloudSignIn: 'Bei ShellGPT Cloud anmelden',
      cloudSignedIn: 'Bei ShellGPT Cloud angemeldet',
      cloudNeedsSignIn: 'Melden Sie sich bei ShellGPT Cloud an, um die Agents in Ihrem Konto zu finden.',
      cloudSignedInDesc:
      ...
      cloudDiscoverFailed: 'Ihre ShellGPT-Cloud-Agents konnten nicht geladen werden',
      cloudConnectFailed: 'Keine Verbindung zu diesem Agent möglich',
      cloudSignInFailed: 'Anmeldung bei ShellGPT Cloud fehlgeschlagen',
      cloudSignedOutTitle: 'Von ShellGPT Cloud abgemeldet',
      cloudSignedOutMessage: 'Die ShellGPT-Cloud-Session wurde geleert.',
      ...
      remoteUrlDesc: 'Basis-URL für das Remote-Dashboard-Backend. Pfad-Präfixe werden unterstützt, z. B. /shellgpt.',
      ...
      restartingMessage:
        'ShellGPT Desktop stellt mit den gespeicherten Einstellungen die Verbindung wieder her — die Shell bleibt offen.',
      savedMessage: 'Für den nächsten Neustart gespeichert.',
      connectedTo: (baseUrl, version) => `Verbunden mit ${baseUrl}${version ? ` · ShellGPT ${version}` : ''}`,
      ...
      sshDesc:
        'ShellGPT wird per SSH auf dem Remote-Gerät gestartet und in diese App getunnelt – Sie müssen nichts selbst starten oder freigeben. Erfordert funktionierenden, schlüsselbasierten SSH-Zugriff auf den Host.',
      ...
      sshShellGPTPathTitle: 'ShellGPT-Pfad (optional)',
      sshShellGPTPathDesc: 'Vollständiger Pfad zum Remote-ShellGPT-Binary. Leer = automatisch erkennen.',
      sshShellGPTPathPlaceholder: 'automatisch erkennen',
      ...
      sshReachable: (host, platform) => `Erreichbar: ${host} (${platform}) — ShellGPT gefunden`,
      ...
      sshErrAuth:
        'SSH-Authentifizierung fehlgeschlagen. Laden Sie Ihren Schlüssel in den ssh-agent (ssh-add) oder setzen Sie eine IdentityFile in ~/.ssh/config – ShellGPT führt ssh nicht interaktiv aus.',
      sshErrHostKey:
      ...
      sshErrNotInstalled:
        'ShellGPT ist auf dem Remote-Host nicht installiert. Installieren Sie es dort (curl -fsSL https://shellgpt-agent.nousresearch.com/install.sh | sh) oder legen Sie den ShellGPT-Pfad fest.',
      sshErrPlatform:
        'Nicht unterstützte Remote-Plattform. Der Desktop-SSH-Modus von ShellGPT unterstützt Linux-, macOS- und Windows-Remote-Hosts.',
      sshErrTimeout: 'SSH-Verbindung ist ausgelaufen. Der Host ist möglicherweise nicht erreichbar oder schläft.',
      sshErrUpdateRequired: 'Aktualisieren Sie ShellGPT auf dem Remote-Host, bevor Sie sich mit Desktop-SSH verbinden.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'Ein Link möchte diesen MCP-Server zu ShellGPT hinzufügen. Prüfen Sie die genaue Konfiguration unten – sie stammt vom Link, nicht von ShellGPT.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend}-Backend. ShellGPT startet und verwaltet den Server für Sie.`,
      ...
      upToDateDetail: (tag, backend) =>
        `llama.cpp ${tag} (${backend}) wird ausgeführt — der neueste Build, den ShellGPT mitliefert.`,
    ...
    billing: {
      ...
      errors: {
        ...
        cliBillingDisabled: {
          ...
          message:
            'Remote-Ausgaben sind für dieses Konto deaktiviert – ein Abrechnungsadministrator kann sie auf der ShellGPT-Agent-Seite des Portals aktivieren.'
        },
        roleRequired: {
    ...
    providers: {
      ...
      intro:
        'Melden Sie sich mit einem Abo an – kein API-Key zum Kopieren. ShellGPT übernimmt die Browser-Anmeldung für Sie, direkt hier in der App.',
      connected: 'Verbunden',
      collapse: 'Einklappen',
      ...
      localEndpoint: {
        ...
        description:
          'Verbinden Sie ShellGPT mit einem beliebigen OpenAI-kompatiblen Endpunkt (Zyphra, vLLM, llama.cpp, Ollama usw.).'
      },
    ...
    toolsets: {
      ...
      terminalBackend: {
        ...
        unavailableMessage: backend =>
          `ShellGPT kann gerade keine Shell-Befehle ausführen: ${backend} ist nicht bereit. Wechseln Sie zu Lokal oder schließen Sie die Einrichtung von ${backend} ab und versuchen Sie es erneut.`,
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Lassen Sie ShellGPT mit einem Schnappschuss Ihres Standard-Browserprofils browsen, damit Websites bereits angemeldet öffnen.',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Wiederherstellbar über „shellgpt curator restore“.',
    tabPlugins: 'Plugins',
    plugins: {
      ...
      defaultProfile: 'ShellGPT (Standard)',
      kindAgent: 'Agent',
      kindDesktop: 'Desktop',
      ...
      legacyBackend:
        'Dieses Backend ist älter als schlüsseladressierte Plugin-Schalter — aktualisieren Sie ShellGPT, um es hier zu verwalten.',
      ...
      catalogProvenance: sha => `Aus dem ShellGPT-Katalog installiert${sha ? ` am Pin ${sha}` : ''}.`,
      ...
      deepLinkCatalogUnknown: (name: string) =>
        `\u201E${name}\u201C ist nicht im ShellGPT-Plugin-Katalog. Es wurde nichts installiert.`,
      deepLinkCatalogUnavailable:
        'Der ShellGPT-Plugin-Katalog konnte nicht geladen werden. Prüfen Sie Ihre Verbindung und öffnen Sie den Link erneut.',
  ...
  starmap: {
    ...
    emptyDesc: 'Sobald ShellGPT Skills und Erinnerungen zu Ihrer Arbeit aufbaut, erscheinen sie hier.',
    share: 'Map teilen',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Starten Sie ShellGPT neu, um Pets zu verwenden – das Backend ist älter als diese Funktion.',
    ...
    generatePet: {
      ...
      staleBackend: 'Aktualisieren Sie ShellGPT, um Pets zu generieren.',
      backgroundHint: 'Sie können dieses Fenster schließen – ShellGPT benachrichtigt Sie, wenn es fertig ist.',
    ...
    nav: {
      ...
      settings: {
        title: 'Einstellungen',
        detail: 'ShellGPT Desktop konfigurieren'
      },
      capabilities: {
        title: 'Fähigkeiten',
    ...
    shellgptActiveSessions: (version, count) => `ShellGPT ${version} · Aktive Sessions ${count}`,
  ...
  messaging: {
    ...
    telegramQr: {
      ...
      subtitle:
        'Beide Optionen verbinden einen Bot, den Sie kontrollieren, und speichern seine Zugangsdaten nur in dieser ShellGPT-Installation.',
      quickSetup: 'Schnelleinrichtung',
      recommended: 'Empfohlen',
      quickHelp:
        'Scannen Sie einen QR-Code und bestätigen Sie in Telegram. ShellGPT legt den Bot an und erkennt Ihre Telegram-Benutzer-ID automatisch.',
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description:
        'Sessions in diesem Profil laufen auf dem von Ihnen festgelegten Remote-ShellGPT statt auf diesem Computer.',
    ...
    defaultDescription:
      'Wird beim Öffnen von ShellGPT und für neue Chats verwendet. Bestehende Sessions bleiben in ihren Profilen.',
    ...
    deleting: 'Wird gelöscht...',
    createDesc: 'Profile sind unabhängige ShellGPT-Umgebungen: eigene Config, eigene Skills und eigene SOUL.md.',
    nameLabel: 'Name',
  ...
  modelAssignment: {
    saveFailed: 'ShellGPT hat diese Modelländerung nicht gespeichert.',
  ...
  cron: {
    ...
    newCron: 'Neuer Cron',
    emptyDescNew:
      'Planen Sie einen Prompt, der nach einem Cron-Ausdruck ausgeführt wird. ShellGPT führt ihn aus und liefert die Ergebnisse an das von Ihnen gewählte Ziel.',
  ...
  sidebar: {
    ...
    storageCorrupt: {
      ...
      body: (profiles: string) =>
        `ShellGPT kann nicht den gesamten Session-Verlauf für ${profiles} lesen. Chats, die in dieser Liste fehlen, wurden nicht gelöscht; die Datei, in der sie gespeichert sind, ist beschädigt.`,
      action:
        'Beenden Sie ShellGPT für dieses Profil und prüfen Sie die Datei dann, ohne sie zu ändern, oder stellen Sie einen Snapshot wieder her:',
    ...
    projects: {
      ...
      staleBackend:
        'Aktualisieren Sie das ShellGPT-Backend, um Projekte zu erstellen – Ihr Backend ist älter als diese Desktop-App (Einstellungen → Updates → Backend).',
      deleteConfirm:
        'Das entfernt das gespeicherte Projekt aus ShellGPT. Dateien, Git-Repos und Worktrees bleiben unberührt.',
      ...
      worktreeStaleBackend:
        'Aktualisieren Sie das ShellGPT-Backend, um Worktrees über diese Remote-Verbindung zu erstellen – es ist älter als die Git-Worktree-API.',
  ...
  composer: {
    ...
    placeholderStarting: 'ShellGPT wird gestartet…',
    placeholderReconnecting: 'Verbindung zu ShellGPT wird wiederhergestellt…',
    placeholderFollowUp: 'Folge senden',
    newSessionPlaceholders: [
      'Was bauen wir?',
      'Geben Sie ShellGPT eine Aufgabe',
    ...
    voiceEngineChained: 'Sprache-zu-Text + ShellGPT-Stimme',
    voiceEngineLive: 'GPT-Live (Vollduplex, delegiert an ShellGPT)',
    ...
    commandDescs: {
      ...
      '/goal': 'Ein dauerhaftes Ziel festlegen, an dem ShellGPT über mehrere Turns arbeitet, bis es erreicht ist',
      ...
      '/plan': 'Einen Markdown-Umsetzungsplan in .shellgpt/plans/ schreiben, ohne etwas auszuführen',
      ...
      '/profile': 'Aktives ShellGPT-Profil wechseln',
      ...
      '/version': 'ShellGPT-Agent-Version anzeigen',
    ...
    attachUrlDesc: 'ShellGPT ruft die Seite ab und fügt sie als Kontext für diesen Turn hinzu.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'ShellGPT bitten, einen PR zu öffnen',
  ...
  updates: {
    stages: {
      ...
      update: 'Aktualisiert ShellGPT…',
      rebuild: 'Baut die Desktop-App neu…',
      restart: 'Startet ShellGPT neu…',
    ...
    unsupportedMessage: 'Diese ShellGPT-Version kann sich nicht aus der App heraus aktualisieren.',
    connectionRetry: 'Prüfen Sie Ihre Verbindung und versuchen Sie es erneut.',
    gitUnusable: 'ShellGPT konnte Git auf diesem Computer nicht ausführen und daher nicht nach Updates suchen.',
    connectionSettings: 'Verbindungseinstellungen',
    ...
    availableBody: 'Eine neue ShellGPT-Version ist bereit zur Installation.',
    availableTitleBackend: 'Backend-Update verfügbar',
    availableBodyBackend: 'Eine neuere Version des verbundenen ShellGPT-Backends ist bereit zur Installation.',
    ...
    manualBody:
      'Sie haben ShellGPT über die Befehlszeile installiert, daher laufen Updates auch dort. Fügen Sie dies in Ihr Terminal ein:',
    manualPickedUp: 'ShellGPT übernimmt die neue Version beim nächsten Start.',
    guiSkewTitle: 'Desktop-App aktualisieren',
    guiSkewBody:
      'Das Backend wurde aktualisiert, aber dieses Desktop-App-Paket nicht. Aktualisieren oder installieren Sie die ShellGPT-Desktop-App neu (Ihr AppImage / .deb / .rpm), um beide abzugleichen.',
    copy: 'Kopieren',
    copied: 'Kopiert',
    done: 'Fertig',
    applyingBody:
      'Der ShellGPT-Updater übernimmt in einem eigenen Fenster und öffnet ShellGPT automatisch wieder, wenn er fertig ist. Bitte öffnen Sie ShellGPT während des Updates nicht selbst erneut.',
    applyingBodyBackend:
      'Das Remote-Backend wendet das Update an und startet neu. ShellGPT verbindet sich automatisch wieder, wenn es zurück ist.',
    applyingClose: 'Dieses Fenster schließt sich während des Updates, dann öffnet sich ShellGPT von selbst wieder.',
    errorTitle: 'Update nicht abgeschlossen',
    errorBody: 'Keine Sorge – es ging nichts verloren. Sie können es jetzt erneut versuchen.',
    blockerTitle: 'Lokale Vorschauen schließen, um ShellGPT zu aktualisieren?',
    blockerBody:
      'ShellGPT muss diese lokalen Vorschauen vor dem Update stoppen. Ihre Dateien werden dabei weder geändert noch gelöscht.',
    foreignBlockerTitle: 'Andere Prozesse schließen, um ShellGPT zu aktualisieren',
    foreignBlockerBody:
      'ShellGPT kann diese Prozesse nicht sicher automatisch beenden. Schließen Sie die App, das Terminal oder den Dienst, zu dem sie gehören, und versuchen Sie das Update erneut.',
    mixedBlockerBody:
      'ShellGPT kann die unten aufgeführten lokalen Vorschauen schließen. Andere Prozesse müssen manuell geschlossen werden, bevor das Update fortgesetzt werden kann.',
  ...
  handoffTour: {
    ...
    stayTitle: 'ShellGPT ist einen Klick entfernt',
    stayText:
      'Wechseln Sie ins Einrichtungsprofil und öffnen Sie „Willkommen bei ShellGPT“, wenn Sie Hilfe brauchen. Es bleibt dort.'
  },
  guidedGreeting: {
    line: 'Hallo und willkommen. Ich bin ShellGPT. Geben Sie mir zwei Minuten, um alles für Sie einzurichten, dann setzen wir mich auf etwas an, das Sie wirklich erledigt haben möchten.\\n\\nAber zuerst: Wie soll ich Sie nennen?',
  ...
  install: {
    ...
    oneTimeTitle: 'ShellGPT braucht eine einmalige Installation',
    ...
    setupChoiceTitle: 'ShellGPT Desktop einrichten',
    setupChoiceDesc:
      'Verbinden Sie diese App mit einem ShellGPT Gateway, das Sie bereits betreiben, oder installieren Sie ShellGPT lokal auf diesem Computer.',
    connectExistingTitle: 'Mit bestehendem ShellGPT verbinden',
    ...
    installLocalTitle: 'ShellGPT lokal installieren',
    installLocalDesc:
      'ShellGPT herunterladen, seine Python-Umgebung erstellen und das Backend auf diesem Computer ausführen.',
    localStartUnavailable:
      'Die lokale Installation konnte nicht gestartet werden. Starten Sie ShellGPT Desktop neu und versuchen Sie es erneut.',
    remoteSetupTitle: 'Mit bestehendem ShellGPT verbinden',
    remoteSetupDesc:
      'Geben Sie die URL Ihres Gateways ein. ShellGPT Desktop erkennt, ob ein Token oder eine Browser-Anmeldung nötig ist.',
    remoteUrlTitle: 'Gateway-URL',
    remoteUrlDesc: 'Verwenden Sie die Basis-URL des ShellGPT Gateways, bei Remote-Gateways einschließlich https://.',
    remoteUrlPlaceholder: 'https://gateway.example.com/shellgpt',
    probing: 'Gateway-Authentifizierung wird erkannt...',
    probeError: 'Dieses ShellGPT Gateway konnte nicht erreicht werden.',
    ...
    settingUpTitle: 'ShellGPT Agent wird eingerichtet',
    finishingTitle: 'Wird abgeschlossen',
    failedDesc:
      'Einer der Installationsschritte ist fehlgeschlagen. Unter Windows kann das passieren, wenn eine andere ShellGPT-CLI- oder Desktop-Instanz läuft. Beenden Sie alle laufenden ShellGPT-Instanzen und versuchen Sie es dann erneut. Das vollständige Protokoll finden Sie in den Details unten oder im Desktop-Log.',
    activeDesc:
      'Das ist eine einmalige Einrichtung. Der ShellGPT-Installer lädt Abhängigkeiten herunter und konfiguriert Ihren Computer. Bei späteren Starts wird dieser Schritt übersprungen.',
  ...
  onboarding: {
    headerTitle: 'ShellGPT Agent für Sie einrichten',
    headerDesc:
      'Verbinden Sie einen Modell-Anbieter, um mit dem Chatten zu beginnen. Die meisten Optionen brauchen nur einen Klick.',
    preparingInstall:
      'ShellGPT schließt die Installation ab. Das dauert beim ersten Start normalerweise unter einer Minute.',
    starting: 'ShellGPT wird gestartet…',
    ...
    recommended: 'Empfohlen',
    connected: 'Verbunden',
    featuredPitch: 'Ein Abo, 300+ Frontier-Modelle – die empfohlene Art, ShellGPT zu nutzen',
    ...
    apiKeyOptions: {
      ...
      local: {
        ...
        description:
          'Verbinden Sie ShellGPT mit einem lokalen oder selbst gehosteten OpenAI-kompatiblen Endpunkt (vLLM, llama.cpp, Ollama usw.).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Öffnet eine Verifizierungsseite in Ihrem Browser – ShellGPT verbindet sich automatisch',
    ...
    authorizeThere: 'Autorisieren Sie ShellGPT dort.',
    ...
    autoBrowser: provider =>
      `Wir haben ${provider} in Ihrem Browser geöffnet. Autorisieren Sie ShellGPT dort, und Sie werden automatisch verbunden – nichts zu kopieren oder einzufügen.`,
  ...
  freeTier: {
    ...
    readyTitle: 'ShellGPT ist bereit.',
    ...
    busyBody: wait =>
      `ShellGPT konnte Ihre Anmeldung nicht abschließen, weil der Nous-Dienst ausgelastet ist. Versuchen Sie es in ${wait} erneut. Ihre Session bleibt so lange erhalten.`,
    unreachableBody:
      'ShellGPT konnte den Nous-Dienst nicht erreichen, um Ihre Anmeldung abzuschließen. Prüfen Sie Ihre Internetverbindung und versuchen Sie es erneut. Ihre Session bleibt erhalten.',
    alreadySignedInHeading: 'Bereits angemeldet.',
    alreadySignedInBody: 'Dieses ShellGPT ist bereits mit einem Nous-Konto angemeldet.',
    setupFailed: {
      gateClosed:
        'Diese ShellGPT-Version kann ohne Nous-Konto nicht starten. Melden Sie sich an oder legen Sie eines an – kostenlos und in einer Minute erledigt.',
      paused:
        'Chatten ohne Anmeldung ist vorübergehend pausiert. ShellGPT prüft weiter. Die Anmeldung ist kostenlos, und Sie können sofort weitermachen.',
      rateLimited: wait =>
        `Gerade starten sehr viele Leute, deshalb versucht ShellGPT es in ${wait} erneut. Die Anmeldung ist kostenlos und überspringt das Warten.`,
      unreachable:
        'ShellGPT konnte den Nous-Dienst nicht erreichen. Prüfen Sie Ihre Internetverbindung und tippen Sie dann auf „Erneut versuchen“. Oder verbinden Sie vorerst einen anderen Anbieter.',
      serverError:
      ...
      generic:
        'ShellGPT konnte den kostenlosen Zugang ohne Anmeldung nicht einrichten. Die Anmeldung ist kostenlos — oder verbinden Sie einen anderen Anbieter.',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} ist ${size}. ShellGPT zeigt nur die ersten 512 KB an.`,
    ...
    web: {
      ...
      restarting: 'ShellGPT wird neu gestartet …',
      askRestart: 'ShellGPT bitten, den Server neu zu starten',
      lookingRestart: taskId => `ShellGPT sucht nach einem Vorschau-Server zum Neustarten (${taskId})`,
      restartingTitle: 'Vorschau-Server wird neu gestartet',
      restartingMessage: 'ShellGPT arbeitet im Hintergrund. Beobachte im Fortschritt die Vorschau-Konsole.',
      ...
      blankPageBody: 'Geben Sie oben eine Adresse ein, um zu browsen, oder bitten Sie ShellGPT, eine Seite zu öffnen.',
      finishedRestarting: message => `ShellGPT hat den Vorschau-Server neu gestartet${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'ShellGPT konnte den Server nicht neu starten.',
      stillWorking:
        'ShellGPT arbeitet noch, aber es ist noch kein Ergebnis des Neustarts eingetroffen. Der Server-Befehl läuft möglicherweise im Vordergrund.',
  ...
  interfaceMode: {
    ...
    hint: 'Ändert, was angezeigt wird, nicht was ShellGPT kann.',
    sessionNote:
    ...
    simple: {
      label: 'Einfach',
      description: 'Zum Chatten mit ShellGPT. Seitenleiste und Chat; keine Terminal-, Datei- oder Diff-Bereiche.'
    },
    advanced: {
      label: 'Erweitert',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'ShellGPT lädt eine Antwort',
      ...
      errorLayerBodies: {
        ...
        disk: 'Ihre Festplatte ist voll, daher konnte ShellGPT dieses Gespräch nicht speichern. Geben Sie Speicherplatz frei und versuchen Sie es erneut.',
        endpoint:
          'ShellGPT erreicht Ihren eigenen Modellserver nicht. Prüfen Sie, ob er läuft, und senden Sie Ihre Nachricht erneut.',
        gateway:
          'Beim Starten dieser Antwort ist in ShellGPT ein internes Problem aufgetreten. Senden Sie Ihre Nachricht erneut; wenn es bestehen bleibt, senden Sie Diagnosedaten.',
        generic:
      ...
      errorCodes: {
        ...
        ssl_cert_verification: {
          ...
          body: provider =>
            `ShellGPT konnte die sichere Verbindung zu ${provider} nicht verifizieren. Prüfen Sie Ihre Netzwerk- oder Proxy-Einstellungen oder wechseln Sie den Anbieter und senden Sie Ihre Nachricht erneut.`
        },
        context_overflow: {
        ...
        invalid_response: {
          ...
          body: provider =>
            `${provider} hat etwas zurückgegeben, das ShellGPT nicht lesen konnte. Versuchen Sie es gleich erneut.`
        },
        empty_response: {
        ...
        loop_error: {
          title: 'ShellGPT ist in einer Schleife hängen geblieben',
          body: 'Die Antwort hat dieselben Schritte wiederholt, daher hat ShellGPT sie gestoppt. Versuchen Sie es erneut oder starten Sie einen neuen Chat, wenn es wieder passiert.'
        },
        SESSION_NOT_OWNED: {
          title: 'Dieser Chat ist woanders offen',
          body: 'Dieser Chat ist gerade in einem anderen ShellGPT-Fenster oder Terminal geöffnet. Schließen Sie ihn dort und senden Sie Ihre Nachricht erneut, oder starten Sie hier einen neuen Chat.'
        },
        disk_full: {
          title: 'Festplatte voll',
          body: 'Ihre Festplatte ist voll, daher konnte ShellGPT dieses Gespräch nicht speichern. Geben Sie Speicherplatz frei und versuchen Sie es erneut.'
        },
        free_tier_disabled: {
        ...
        free_tier_model_not_free: {
          ...
          body: 'ShellGPT verwendet vorerst das kostenlose Modell. Melden Sie sich mit einem Nous-Konto an, um mehr Modelle zu nutzen – es ist kostenlos.'
        },
        free_tier_route: {
          title: 'ShellGPT hat das kostenlose Modell über diese Route nicht erreicht',
        ...
        free_tier_refused: {
          title: 'ShellGPT konnte das ohne Anmeldung nicht senden',
      ...
      errorToastTitle: 'ShellGPT konnte die Antwort nicht fertigstellen',
      ...
      errorOpenShellGPTFolder: 'ShellGPT-Ordner öffnen',
      errorOpenShellGPTFolderFailed: 'Der ShellGPT-Ordner konnte nicht geöffnet werden',
    ...
    approval: {
      gatewayDisconnected: 'ShellGPT-Gateway ist nicht verbunden',
      sendFailed: 'Genehmigungsantwort konnte nicht gesendet werden',
      reconnect: 'Neu verbinden',
      timedOutSystemLine:
        'Die Freigabe ist abgelaufen — der Befehl wurde nicht ausgeführt. Bitten Sie ShellGPT, es erneut zu versuchen, oder erhöhen Sie das Limit unter Einstellungen → Sicherheit → Freigabe-Timeout.',
      ...
      alwaysDescription: pattern =>
        `Dies fügt das Muster „${pattern}“ Ihrer dauerhaften Zulassungsliste hinzu (~/.shellgpt/config.yaml). ShellGPT fragt bei solchen Befehlen nicht mehr nach – weder in dieser noch in zukünftigen Sessions.`,
  ...
  prompts: {
    gatewayDisconnected: 'Das ShellGPT-Gateway ist nicht verbunden',
    reconnect: 'Neu verbinden',
    ...
    sudoDesc:
      'ShellGPT benötigt Ihr Sudo-Passwort, um einen privilegierten Befehl auszuführen. Es wird nur an Ihren lokalen Agenten gesendet.',
    ...
    sudoInstallDesc:
      'ShellGPT benötigt Ihr sudo-Passwort, um die Bot-Screen-Pakete (TigerVNC + Xfce) auf dem Gateway-Host zu installieren. Es wird nur an diesen Host gesendet.',
    sudoPlaceholder: 'Sudo-Passwort',
    secretTitle: 'Geheimnis erforderlich',
    secretDesc: 'ShellGPT benötigt eine Zugangsdaten, um fortzufahren.',
    ...
    vaultSaveDesc: origin =>
      `ShellGPT ist auf eine Anmeldeseite unter ${origin} gestoßen und hat dafür keinen Login. Geben Sie ihn einmal hier ein; er wird auf diesem Rechner verschlüsselt und in die Seite eingetragen, ohne dass das Modell das Passwort je sieht.`,
    ...
    vaultCodeDesc: site =>
      `${site} verlangt einen Einmalcode (SMS, E-Mail oder Authenticator-App). Geben Sie ihn hier ein, ShellGPT trägt ihn in die Seite ein; das Modell sieht ihn nie.`,
    vaultCodeLabel: 'Code',
    vaultCodeFootnote:
      'Tipp: Speichern Sie den Authentifizierungsschlüssel zusammen mit diesem Login unter Einstellungen → Passwörter & Logins, dann gibt ShellGPT die Codes für Sie ein.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Starten Sie ShellGPT Desktop neu, um „Bild speichern“ zu verwenden.',
    restartToSaveImages: 'Starten Sie ShellGPT Desktop neu, um Bilder zu speichern',
    ...
    handoff: {
      ...
      timedOut: 'Zeitüberschreitung beim Warten auf das Gateway. Läuft `shellgpt gateway`?',
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        ...
        text: 'Skills sind Ordner mit Anweisungen, die ShellGPT lädt, wenn die Arbeit danach verlangt.'
      },
      messaging: {
        title: 'ShellGPT abseits Ihres Schreibtischs',
        text: 'Verbinden Sie Telegram, Discord, Slack und mehr – derselbe Agent, dasselbe Gedächtnis.'
      },
      artifacts: {
        title: 'Alles, was ShellGPT gemacht hat',
      ...
      profiles: {
        ...
        text: 'Jedes ist sein eigenes ShellGPT — eigene Schlüssel, eigenes Gedächtnis, eigene Sessions.'
      },
      'composer-mentions': {
