...
export const fr = defineLocale({
  ...
  connectors: {
    ...
    disclaimer: "La connexion est facultative. N'autorisez que les applications que vous voulez confier à ShellGPT.",
  ...
  connectorsPage: {
    ...
    card: {
      ...
      inCatalog: 'Dans le catalogue ShellGPT',
    ...
    page: {
      ...
      noMatchBody: 'Aucun résultat. Indiquez à ShellGPT votre propre serveur MCP pour l’ajouter.',
      ...
      disconnectNoAccount: 'ShellGPT n’a aucun compte à déconnecter ici. Actualisez la page et réessayez.',
      disconnectRefused:
    ...
    dialog: {
      ...
      disconnectBody: "ShellGPT cesse d'agir avec ce compte. Vous pouvez vous reconnecter à tout moment.",
      ...
      appSwitch: (name: string) => `ShellGPT peut utiliser ${name}`,
      ...
      wayHosted: 'Géré',
      bothOn: (name: string) => `Les deux sont activés : ShellGPT voit donc chaque outil ${name} en double.`,
      ...
      rulesSignIn: 'Connectez-vous pour modifier ce que ShellGPT peut faire ici.',
    ...
    tools: {
      ...
      summaryTitle: (name: string) => `Ce que ShellGPT peut faire avec ${name}`,
      summaryPreviewTitle: (name: string) => `Ce que ShellGPT pourra faire avec ${name} une fois connecté`,
      ...
      goneBody: "ShellGPT ne peut plus l'appeler. La ligne reste jusqu'à ce que vous la supprimiez : rien ne disparaît.",
      remove: 'Supprimer',
  ...
  sessionImport: {
    ...
    subtitle: 'Importez une conversation dans ShellGPT et reprenez là où vous en étiez.',
    ...
    chooseHelp: "Choisissez une session pour lire son historique avant de l'importer dans ShellGPT.",
    ...
    you: 'Vous',
    snapshot: 'Cette conversation est déjà dans ShellGPT. Ouvrez votre copie existante pour continuer.',
    copyNotice:
    ...
    open: 'Ouvrir dans ShellGPT',
    continue: 'Continuer dans ShellGPT',
  ...
  boot: {
    ready: 'ShellGPT Desktop est prêt',
    desktopBootFailedWithMessage: message => `Échec du démarrage : ${message}`,
    steps: {
      connectingGateway: 'Connexion au gateway desktop',
      loadingSettings: 'Chargement des paramètres ShellGPT',
      loadingSessions: 'Chargement des sessions récentes',
      retryingRemoteBackend: 'Reconnexion au backend ShellGPT distant…',
      startingDesktopConnection: 'Démarrage de la connexion desktop',
      startingShellGPTDesktop: 'Démarrage de ShellGPT Desktop…'
    },
    errors: {
      backgroundExited: "Le processus en arrière-plan de ShellGPT s'est arrêté.",
      backgroundExitedDuringStartup: "Le processus en arrière-plan de ShellGPT s'est arrêté pendant le démarrage.",
      backendStopped: 'Backend arrêté',
      restartShellGPT: 'Redémarrer ShellGPT',
      openLogs: 'Ouvrir les journaux',
    ...
    causes: {
      exitedEarly: "Le service en arrière-plan de ShellGPT s'est arrêté juste après son démarrage.",
      timedOut: "Le service en arrière-plan de ShellGPT n'a pas répondu à temps.",
      permission: "ShellGPT n'a pas pu écrire dans son dossier de données (problème d'autorisation).",
      diskFull: "Le disque est plein ; ShellGPT n'a donc pas pu démarrer.",
      portInUse: 'Un autre programme utilise le port réseau nécessaire à ShellGPT.',
      installMissing:
        "Une partie de l'installation de ShellGPT est manquante. Choisissez Réparer l'installation pour la restaurer."
    },
    failure: {
      title: "ShellGPT n'a pas pu démarrer",
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Votre backend ShellGPT est plus ancien que cette version du desktop et peut ne pas fonctionner correctement. Mettez-le à jour pour les aligner.',
    installMethodUnsupportedTitle: "Méthode d'installation non prise en charge",
    updateShellGPT: 'Mettre à jour ShellGPT',
    ...
    errors: {
      ...
      storageFailure:
        "ShellGPT n'a pas pu enregistrer dans son dossier de données. Ouvrez Maintenance pour le vérifier et le réparer.",
      gatewayAuthFailed: "Échec de l'authentification du gateway — vérifiez API_SERVER_KEY.",
      methodNotAllowed:
        'Le backend du desktop a rejeté cette requête (405 Method Not Allowed). Essayez de redémarrer ShellGPT Desktop.',
      ...
      restartShellGPTFailed: 'Impossible de redémarrer ShellGPT'
    },
    actions: {
      restartShellGPT: 'Redémarrer ShellGPT',
    ...
    voice: {
      ...
      liveDelegationFailed: 'Impossible de transmettre la demande à ShellGPT',
    ...
    native: {
      ...
      inputBody: 'ShellGPT attend votre réponse.',
      turnDoneTitle: 'ShellGPT a terminé',
      turnDoneBody: '',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'Vous pouvez également exécuter `shellgpt debug share --nous` dans un terminal, ou `shellgpt debug share --local` pour afficher le rapport sans le téléverser.',
  ...
  settings: {
    ...
    resetConfirm: 'Réinitialiser tous les paramètres aux valeurs par défaut de ShellGPT ?',
    ...
    plugins: {
      ...
      installModal: {
        ...
        catalogPinned: (name, sha) =>
          `Entrée « ${name} » du catalogue ShellGPT — le composant agent sera installé depuis le commit vérifié${sha ? ` ${sha}` : ''}, et non depuis la tête de branche.`,
    ...
    vault: {
      ...
      otpHint:
        "La « clé d'installation » que le site affiche lorsque vous activez 2FA. Avec elle enregistrée, ShellGPT génère lui-même les codes.",
      ...
      sources: {
        ...
        notInstalled: name =>
          `Non détecté. Installez l’outil en ligne de commande ${name} et connectez-vous ; ShellGPT le repère automatiquement.`,
        disabledDesc: 'Détecté mais désactivé pour ShellGPT.',
        lockedDesc:
          "Détecté. L'agent vous demandera de le déverrouiller lorsqu'il en a besoin, ou déverrouillez maintenant.",
        unlockedDesc:
          "Déverrouillé pour cette session. Se verrouille automatiquement après 30 minutes d'inactivité ou lorsque ShellGPT se ferme.",
    ...
    notifications: {
      ...
      focusedHint: 'Les alertes de fin ne se déclenchent que quand ShellGPT est en arrière-plan.',
      kinds: {
        approval: {
        ...
        input: {
          ...
          description: "ShellGPT a posé une question ou a besoin d'un mot de passe ou d'un secret."
        },
        turnDone: {
          label: 'Réponse prête',
          description: "Un tour s'est terminé pendant que ShellGPT était en arrière-plan."
        },
        turnError: {
          label: 'Échec du tour',
        ...
        plugin: {
          ...
          description: 'Un plugin desktop a envoyé une notification pendant que ShellGPT était en arrière-plan.'
        }
      },
    ...
    searchPlaceholder: {
      about: 'À propos de ShellGPT Desktop',
    ...
    appearance: {
      ...
      colorModeDesc: 'Choisissez un mode fixe ou laissez ShellGPT suivre le paramètre système.',
      ...
      reactionsDesc: 'Réactions emoji façon iMessage — réagissez aux messages, et ShellGPT peut réagir aux vôtres.',
      tipsTitle: "Astuces dans l'application",
      tipsDesc:
        "Une petite bulle désigne occasionnellement une partie de l'application lorsque vous êtes inactif ou lorsque ShellGPT peut vous aider. Fermer une astuce la masque définitivement.",
      tipsReset: (count: number) =>
        `Réafficher ${count} astuce${count === 1 ? '' : 's'} fermée${count === 1 ? '' : 's'}`,
      toursTitle: 'Visites guidées',
      toursDesc:
        "Laissez ShellGPT vous guider dans l'application en assombrissant l'écran et en mettant chaque étape en évidence.",
      ...
      pet: {
        ...
        intro:
          "Adoptez une mascotte petdex animée qui flotte au-dessus de l'application et réagit aux actions de ShellGPT — court pendant l'exécution des outils, fête les réussites, boude les erreurs.",
        restartHint:
          "Les animaux de compagnie nécessitent un redémarrage rapide — l'application en cours a démarré avant l'ajout de cette fonctionnalité. Fermez et rouvrez ShellGPT, puis revenez ici.",
        scaleTitle: 'Taille',
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      fileReadMaxChars: 'Nombre maximal de caractères que ShellGPT peut lire dans une demande de fichier.',
      approvals: {
        mode: 'Comment ShellGPT gère les commandes nécessitant une approbation explicite.',
      ...
      voice: {
        ...
        voiceChatMode:
          'chained : reconnaissance vocale → ShellGPT → synthèse vocale avec les fournisseurs ci-dessous. gpt-live : un modèle vocal OpenAI full-duplex (gpt-live-1) écoute et parle, et confie chaque vraie demande à ShellGPT — le modèle que vous avez sélectionné répond avec l’ensemble des outils. Nécessite une clé API OpenAI ; la couche vocale est facturée 0,05 $ par minute.',
        gptLive: {
          voice: 'Voix du mode GPT-Live. Les identifiants de voix personnalisés sont acceptés.',
          instructions:
            'Phrases supplémentaires pour la personnalité vocale en direct (ton, rythme, langue). ShellGPT conserve son propre prompt système.'
        }
      },
      tts: {
        xai: {
      ...
      updates: {
        nonInteractiveLocalChanges:
          "Quand ShellGPT se met à jour depuis l'application (sans invite de terminal), conserve les modifications locales (stash) ou les abandonne (discard). Les mises à jour via le terminal demandent toujours confirmation."
      }
    }),
    uninstallSection: {
      dangerZone: 'Zone dangereuse',
      checkingInstalled: 'Vérification des éléments installés…',
      uninstallShellGPT: 'Désinstaller ShellGPT',
      chooseHowMuch:
      ...
      options: {
        gui: {
          ...
          description:
            'Supprime cette application de bureau. L’agent ShellGPT, votre configuration et vos conversations sont conservés.',
        ...
        lite: {
          ...
          description:
            'Supprime l’application et l’agent ShellGPT, mais conserve la configuration, les conversations et les secrets pour une future réinstallation.',
          consequence:
            'l’interface de chat et l’agent ShellGPT (la configuration, les conversations et les secrets sont conservés)'
        },
        full: {
          ...
          consequence:
            'TOUT — l’interface de chat, l’agent ShellGPT et l’ensemble de votre configuration, de vos conversations, secrets et journaux'
        }
      }
    },
    poolLimits: {
    ...
    about: {
      ...
      automaticUpdatesDesc:
        "ShellGPT vérifie automatiquement les mises à jour en arrière-plan et vous informe quand l'une est prête.",
    ...
    config: {
      ...
      minimizeToTrayDesc:
        'Réduire les fenêtres ou fermer la fenêtre principale les masque dans la zone de notification (barre des menus sur macOS) et ShellGPT continue de s’exécuter. Utilisez Quitter ShellGPT dans le menu de la zone de notification ou Cmd+Q pour quitter. Désactivé par défaut ; s’applique uniquement à cet appareil.',
      ...
      loading: 'Chargement de la configuration ShellGPT...',
    ...
    hudModifier: {
      ...
      permission:
        'Autorisez ShellGPT dans Réglages Système → Confidentialité et sécurité → Surveillance de l’entrée, puis réessayez. Ce geste n’enregistre pas les frappes et ne capture pas votre écran.',
      unavailable:
        'L’assistant du geste HUD n’a pas pu démarrer ou s’est arrêté de manière inattendue. Réessayez ou redémarrez ShellGPT. Le raccourci HUD existant fonctionne toujours dans ShellGPT.',
      missingHelper:
        'Il manque l’assistant du geste HUD dans cette installation de ShellGPT. Mettez à jour ou réinstallez ShellGPT, puis réessayez.',
      unsupportedSession:
    ...
    screenshot: {
      ...
      enabledDesc:
        "Appuyez simultanément sur les deux touches Commande depuis n'importe quelle application pour capturer sa fenêtre au premier plan et la joindre au brouillon ShellGPT actuel. Rien n'est envoyé automatiquement. Désactivé par défaut et limité à ce Mac. Le contenu peut être sensible : vérifiez la pièce jointe avant l'envoi.",
      ...
      inputPermission:
        "L'autorisation Surveillance de l'entrée permet à ShellGPT de détecter les deux touches Commande lorsqu'une autre application est active. Autorisez ShellGPT dans Réglages Système → Confidentialité et sécurité → Surveillance de l'entrée, puis réessayez.",
      screenPermission:
        "L'autorisation Enregistrement de l'écran permet à ShellGPT de capturer la fenêtre au premier plan. Autorisez ShellGPT dans Réglages Système → Confidentialité et sécurité → Enregistrement de l'écran, puis réessayez. Redémarrez ShellGPT si macOS le demande.",
    ...
    quickEntry: {
      ...
      enabledDesc:
        "Faites apparaître un petit compositeur depuis n'importe où avec un raccourci global et envoyez une invite sans ouvrir ShellGPT.",
    ...
    connections: {
      title: 'Connexions',
      intro:
        'Enregistrez tous les emplacements où vivent vos agents : cet appareil, les gateways distantes de votre réseau et les instances ShellGPT Cloud. Ils sont tous conservés ici.',
      stagedNote:
      ...
      updateSkippedCloud: 'Gérée par ShellGPT Cloud',
      kindLocal: 'Locale',
      kindRemote: 'Gateway distante',
      kindCloud: 'ShellGPT Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: "L'environnement ShellGPT géré par cette application.",
      kindRemoteDesc: 'Une gateway ShellGPT accessible en HTTP(S), par le LAN, Tailscale ou Internet.',
      kindCloudDesc: 'Une instance hébergée découverte via votre compte ShellGPT Cloud.',
      kindSshDesc: 'Une installation ShellGPT accessible en SSH.',
      labelTitle: 'Nom',
      labelDesc:
      ...
      headersDesc:
        "Envoyés avec chaque requête HTTP et WebSocket vers ce gateway, notamment pour les proxys d'accès comme Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Les valeurs sont stockées chiffrées. Les en-têtes gérés par ShellGPT (Authorization, Cookie, Host…) sont ignorés.",
      ...
      cloudAddHint:
        "Astuce : connectez-vous à ShellGPT Cloud ci-dessus pour découvrir automatiquement vos agents — utilisez ce formulaire uniquement pour enregistrer manuellement l'URL d'une instance connue.",
    ...
    gateway: {
      ...
      intro:
        'Local par défaut. Utilisez distant quand cette application doit piloter un backend ShellGPT ailleurs. Remplacements par profil ci-dessous.',
      envOverrideTitle: "Des variables d'environnement contrôlent cette session desktop.",
      envOverrideDesc:
        'Supprimez les variables SHELLGPT_DESKTOP_REMOTE_URL et SHELLGPT_DESKTOP_REMOTE_TOKEN pour utiliser le paramètre enregistré ci-dessous.',
      modeTitle: 'Mode de connexion',
      localTitle: 'Gateway local',
      localDesc:
        "Démarrer un backend ShellGPT privé sur localhost. C'est la valeur par défaut et cela fonctionne hors ligne.",
      remoteTitle: 'Gateway distant',
      remoteDesc: 'Connecter ce shell desktop à un backend ShellGPT distant.',
      remoteAuthHint:
      ...
      cloudDesc:
        "Connectez-vous une fois à ShellGPT Cloud et choisissez parmi les agents de votre compte — pas d'URL à coller.",
      cloudSignInTitle: 'ShellGPT Cloud',
      cloudSignIn: 'Se connecter à ShellGPT Cloud',
      cloudSignedIn: 'Connecté à ShellGPT Cloud',
      cloudNeedsSignIn: 'Connectez-vous à ShellGPT Cloud pour découvrir les agents de votre compte.',
      cloudSignedInDesc:
      ...
      cloudDiscoverFailed: 'Impossible de charger vos agents ShellGPT Cloud',
      cloudConnectFailed: 'Impossible de se connecter à cet agent',
      cloudSignInFailed: 'Échec de la connexion à ShellGPT Cloud',
      cloudSignedOutTitle: 'Déconnecté de ShellGPT Cloud',
      cloudSignedOutMessage: 'Session ShellGPT Cloud effacée.',
      ...
      remoteUrlDesc:
        'URL de base du backend de tableau de bord distant. Les préfixes de chemin sont pris en charge, par exemple /shellgpt.',
      ...
      restartingMessage: 'ShellGPT Desktop va se reconnecter avec les paramètres enregistrés — le shell reste ouvert.',
      savedMessage: 'Enregistré pour le prochain redémarrage.',
      connectedTo: (baseUrl, version) => `Connecté à ${baseUrl}${version ? ` · ShellGPT ${version}` : ''}`,
      ...
      sshDesc:
        "ShellGPT est lancé sur la machine distante via SSH et acheminé vers cette application — rien à démarrer ou exposer soi-même. Nécessite un accès SSH par clé fonctionnel vers l'hôte.",
      sshTrustHint:
      ...
      sshShellGPTPathTitle: 'Chemin ShellGPT (facultatif)',
      sshShellGPTPathDesc: 'Chemin complet vers le binaire shellgpt distant. Vide = détection automatique.',
      sshShellGPTPathPlaceholder: 'détection automatique',
      ...
      sshReachable: (host, platform) => `Accessible : ${host} (${platform}) — ShellGPT trouvé`,
      ...
      sshErrAuth:
        "Échec de l'authentification SSH. Chargez votre clé dans ssh-agent (ssh-add) ou définissez un IdentityFile dans ~/.ssh/config — ShellGPT exécute ssh de manière non interactive.",
      sshErrHostKey:
      ...
      sshErrNotInstalled:
        "ShellGPT n'est pas installé sur l'hôte distant. Installez-le là-bas (curl -fsSL https://shellgpt-agent.nousresearch.com/install.sh | sh) ou définissez le chemin ShellGPT.",
      sshErrPlatform:
        'Plateforme distante non prise en charge. Le mode SSH de ShellGPT Desktop supporte les hôtes distants Linux, macOS et Windows.',
      sshErrTimeout: "Expiration de la connexion SSH. L'hôte peut être inaccessible ou en veille.",
      sshErrUpdateRequired: "Mettez à jour ShellGPT sur l'hôte distant avant de vous connecter avec Desktop SSH.",
    ...
    mcp: {
      ...
      deepLinkDescription:
        "Un lien demande d'ajouter ce serveur MCP à ShellGPT. Vérifiez attentivement la configuration ci-dessous : elle provient du lien, pas de ShellGPT.",
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, backend ${backend}. ShellGPT démarre et gère le serveur pour vous.`,
      ...
      upToDateDetail: (tag, backend) =>
        `llama.cpp ${tag} (${backend}) est en cours d'exécution : il s'agit de la dernière build fournie par ShellGPT.`,
      activeDetail:
    ...
    billing: {
      ...
      errors: {
        ...
        cliBillingDisabled: {
          ...
          message:
            'Les dépenses à distance sont désactivées pour ce compte — un administrateur de facturation peut les activer depuis la page ShellGPT Agent du portail.'
        },
        roleRequired: {
    ...
    providers: {
      ...
      intro:
        "Connectez-vous avec un abonnement — pas de clé API à copier. ShellGPT lance la connexion navigateur pour vous, directement dans l'application.",
      connected: 'Connecté',
      collapse: 'Réduire',
      ...
      localEndpoint: {
        ...
        description:
          "Pointez ShellGPT vers n'importe quel point de terminaison compatible OpenAI (Zyphra, vLLM, llama.cpp, Ollama, etc)."
      },
    ...
    toolsets: {
      ...
      terminalBackend: {
        ...
        unavailableMessage: backend =>
          `ShellGPT ne peut pas exécuter de commandes shell pour le moment : ${backend} n'est pas prêt. Passez en Local ou terminez la configuration de ${backend}, puis réessayez.`,
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: "Autorisez ShellGPT à naviguer avec un instantané de votre profil de navigateur par défaut afin que les sites s'ouvrent avec vos sessions déjà connectées.",
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restaurable via shellgpt curator restore.',
    tabPlugins: 'Plugins',
    plugins: {
      ...
      defaultProfile: 'ShellGPT (par défaut)',
      kindAgent: 'Agent',
      kindDesktop: 'Desktop',
      ...
      legacyBackend: 'Ce backend est trop ancien pour gérer les plugins depuis cet écran ; mettez ShellGPT à jour.',
      ...
      catalogProvenance: (sha: string) =>
        `Installé depuis le catalogue ShellGPT${sha ? ` au commit épinglé ${sha}` : ''}.`,
      ...
      deepLinkCatalogUnknown: (name: string) =>
        `\u00AB\u00A0${name}\u00A0\u00BB ne figure pas dans le catalogue de plugins ShellGPT. Rien n’a été installé.`,
      deepLinkCatalogUnavailable:
        'Impossible de charger le catalogue de plugins ShellGPT. Vérifiez votre connexion et rouvrez le lien.',
  ...
  starmap: {
    ...
    emptyDesc:
      'Au fur et à mesure que ShellGPT construit des skills et des mémoires pour votre travail, ils apparaissent ici.',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Redémarrez ShellGPT pour utiliser les animaux — le backend précède cette fonctionnalité.',
    ...
    generatePet: {
      ...
      staleBackend: 'Mettez à jour ShellGPT pour générer des animaux…',
      backgroundHint: "Vous pouvez fermer — ShellGPT vous notifiera quand c'est terminé.",
    ...
    nav: {
      ...
      settings: {
        title: 'Paramètres',
        detail: 'Configurer ShellGPT Desktop'
      },
      capabilities: {
        title: 'Capacités',
    ...
    shellgptActiveSessions: (version, count) => `ShellGPT ${version} · Sessions actives ${count}`,
  ...
  messaging: {
    ...
    telegramQr: {
      ...
      subtitle:
        "Les deux méthodes connectent un bot que vous contrôlez et enregistrent ses identifiants uniquement dans cette installation d'ShellGPT.",
      quickSetup: 'Configuration rapide',
      recommended: 'Recommandé',
      quickHelp:
        "Scannez un code QR et confirmez dans Telegram. ShellGPT crée le bot et détecte automatiquement votre identifiant d'utilisateur Telegram.",
  ...
  profiles: {
    ...
    connectGateway: 'Connecter un autre gateway ShellGPT…',
    fleet: {
    ...
    remoteOverride: {
      ...
      description:
        "Les sessions de ce profil s'exécuteront sur le système ShellGPT distant indiqué, plutôt que sur cet ordinateur.",
      urlLabel: 'Adresse distante',
      urlPlaceholder: 'https://shellgpt.exemple.fr',
    ...
    defaultDescription:
      "Utilisé à l'ouverture de ShellGPT et pour les nouvelles conversations. Les sessions existantes restent dans leur profil.",
    ...
    deleting: 'Suppression...',
    createDesc: 'Les profils sont des environnements ShellGPT indépendants : configuration, skills et SOUL.md séparés.',
    nameLabel: 'Nom',
  ...
  modelAssignment: {
    saveFailed: 'ShellGPT n’a pas enregistré ce changement de modèle.',
  ...
  cron: {
    ...
    emptyDescNew:
      "Planifiez une invite à exécuter selon une expression cron. ShellGPT l'exécutera et livrera les résultats vers la destination de votre choix.",
  ...
  sidebar: {
    ...
    storageCorrupt: {
      ...
      body: (profiles: string) =>
        `ShellGPT ne peut pas lire tout l’historique des sessions de ${profiles}. Les conversations absentes de cette liste n’ont pas été supprimées ; le fichier qui les contient est endommagé.`,
      action: 'Quittez ShellGPT sur ce profil, puis inspectez le fichier sans le modifier, ou restaurez un instantané :',
    ...
    projects: {
      ...
      staleBackend:
        'Mettez à jour le backend ShellGPT pour créer des projets — votre backend est plus ancien que cette application de bureau (Paramètres → Mises à jour → Backend).',
      deleteConfirm:
        'Cela supprime le projet enregistré de ShellGPT. Les fichiers, dépôts git et worktrees restent inchangés.',
      ...
      worktreeStaleBackend:
        'Mettez à jour le backend ShellGPT pour créer des worktrees depuis Desktop — votre backend est plus ancien que cette application (Paramètres → Mises à jour → Backend).',
  ...
  composer: {
    ...
    placeholderStarting: 'Démarrage de ShellGPT…',
    placeholderReconnecting: 'Reconnexion à ShellGPT…',
    placeholderFollowUp: 'Envoyer un suivi',
    newSessionPlaceholders: [
      'Sur quoi travaillons-nous ?',
      'Donnez une tâche à ShellGPT',
    ...
    voiceEngineChained: 'Reconnaissance vocale + voix ShellGPT',
    voiceEngineLive: 'GPT-Live (duplex intégral, délègue à ShellGPT)',
    ...
    commandDescs: {
      ...
      '/goal':
        'Définir un objectif permanent sur lequel ShellGPT travaille au fil des tours jusqu’à ce qu’il soit atteint',
      ...
      '/plan': 'Écrire un plan d’implémentation markdown dans .shellgpt/plans/ sans rien exécuter',
      ...
      '/profile': 'Changer de profil ShellGPT actif',
      ...
      '/version': 'Afficher la version de ShellGPT Agent',
    ...
    attachUrlDesc: "ShellGPT récupérera la page et l'inclura comme contexte pour ce tour.",
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: "Demander à ShellGPT d'ouvrir une PR",
  ...
  updates: {
    stages: {
      ...
      pull: 'Presque prêt…',
      pydeps: 'Finalisation…',
      update: 'Mise à jour de ShellGPT…',
      rebuild: "Reconstruction de l'application de bureau…",
      restart: 'Redémarrage de ShellGPT…',
    ...
    unsupportedMessage: "Cette version de ShellGPT ne peut pas se mettre à jour depuis l'application.",
    connectionRetry: 'Vérifiez votre connexion et réessayez.',
    gitUnusable: 'ShellGPT n’a pas pu exécuter Git sur cet ordinateur et n’a donc pas pu rechercher de mises à jour.',
    connectionSettings: 'Paramètres de connexion',
    ...
    availableBody: 'Une nouvelle version de ShellGPT est prête à être installée.',
    availableTitleBackend: 'Mise à jour du backend disponible',
    availableBodyBackend: 'Une version plus récente du backend ShellGPT connecté est prête à être installée.',
    ...
    manualBody:
      "Vous avez installé ShellGPT depuis la ligne de commande, les mises à jour s'y effectuent donc aussi. Collez ceci dans votre terminal :",
    manualPickedUp: 'ShellGPT prendra en compte la nouvelle version au prochain lancement.',
    guiSkewTitle: "Mettre à jour l'application de bureau",
    guiSkewBody:
      "Le backend a été mis à jour, mais ce package d'application de bureau ne l'a pas été. Mettez à jour ou réinstallez l'application de bureau ShellGPT (votre AppImage / .deb / .rpm) pour qu'elle corresponde.",
    copy: 'Copier',
    copied: 'Copié',
    done: 'Terminé',
    applyingBody:
      'Le programme de mise à jour de ShellGPT prend le relais dans sa propre fenêtre et rouvre ShellGPT automatiquement une fois terminé. Ne rouvrez pas ShellGPT vous-même pendant la mise à jour.',
    applyingBodyBackend:
      'Le backend distant applique la mise à jour et va redémarrer. ShellGPT se reconnecte automatiquement à son retour.',
    applyingClose: 'Cette fenêtre se fermera pendant la mise à jour, puis ShellGPT se rouvre seul.',
    errorTitle: 'Mise à jour non terminée',
    errorBody: "Pas de souci — rien n'a été perdu. Vous pouvez réessayer maintenant.",
    blockerTitle: 'Fermer les aperçus locaux pour mettre à jour ShellGPT ?',
    blockerBody:
      'ShellGPT doit arrêter ces aperçus locaux avant la mise à jour. Aucun de vos fichiers ne sera modifié ni supprimé.',
    foreignBlockerTitle: 'Fermez les autres processus pour mettre à jour ShellGPT',
    foreignBlockerBody:
      "ShellGPT ne peut pas fermer automatiquement ces processus en toute sécurité. Fermez l'application, le terminal ou le service qui possède chacun d'eux, puis relancez la mise à jour.",
    mixedBlockerBody:
      'ShellGPT peut fermer les aperçus locaux ci-dessous. Les autres processus doivent être fermés manuellement avant de poursuivre la mise à jour.',
  ...
  handoffTour: {
    ...
    stayTitle: "ShellGPT reste à portée d'un clic",
    stayText:
      'Passez au profil de configuration et ouvrez Bienvenue dans ShellGPT lorsque vous avez besoin d’aide. La conversation y reste disponible.'
  },
  guidedGreeting: {
    line: "Salut, entrez ! Je suis ShellGPT. Donnez-moi deux minutes pour préparer les lieux à votre façon, puis nous nous attaquerons à quelque chose que vous voulez vraiment accomplir.\n\nMais d'abord, comment dois-je vous appeler ?",
  ...
  install: {
    ...
    oneTimeTitle: 'ShellGPT nécessite une installation unique',
    ...
    setupChoiceTitle: 'Configurer ShellGPT Desktop',
    setupChoiceDesc:
      'Connectez cette application à un gateway ShellGPT que vous exécutez déjà, ou installez ShellGPT localement sur cet ordinateur.',
    connectExistingTitle: 'Se connecter à un ShellGPT existant',
    ...
    installLocalTitle: 'Installer ShellGPT localement',
    installLocalDesc: 'Téléchargez ShellGPT, créez son environnement Python et exécutez le backend sur cet ordinateur.',
    localStartUnavailable: "L'installation locale n'a pas pu démarrer. Redémarrez ShellGPT Desktop et réessayez.",
    remoteSetupTitle: 'Se connecter à un ShellGPT existant',
    remoteSetupDesc:
      "Entrez l'URL du gateway. ShellGPT Desktop détectera s'il a besoin d'un jeton ou d'une connexion par navigateur.",
    remoteUrlTitle: 'URL du gateway',
    remoteUrlDesc: "Utilisez l'URL de base du gateway ShellGPT, y compris https:// pour les connexions distantes.",
    remoteUrlPlaceholder: 'https://gateway.example.com/shellgpt',
    probing: "Détection de l'authentification du gateway...",
    probeError: "Impossible d'atteindre ce gateway ShellGPT.",
    ...
    settingUpTitle: 'Configuration de ShellGPT Agent',
    finishingTitle: 'Finalisation',
    failedDesc:
      "L'une des étapes d'installation a échoué. Sous Windows, cela peut arriver si une autre instance ShellGPT CLI ou desktop est en cours d'exécution. Arrêtez toutes les instances ShellGPT en cours, puis réessayez. Consultez les détails ci-dessous ou le journal du bureau pour la transcription complète.",
    activeDesc:
      "Il s'agit d'une configuration unique. Le programme d'installation de ShellGPT télécharge les dépendances et configure votre machine. Les lancements suivants ignoreront cette étape.",
  ...
  onboarding: {
    headerTitle: 'Configurons ShellGPT Agent pour vous',
    headerDesc:
      'Connectez un fournisseur de modèles pour commencer à discuter. La plupart des options nécessitent un clic.',
    preparingInstall:
      "ShellGPT finalise l'installation. Cela prend généralement moins d'une minute au premier lancement.",
    starting: 'Démarrage de ShellGPT…',
    ...
    recommended: 'Recommandé',
    connected: 'Connecté',
    featuredPitch: 'Un abonnement, 300+ modèles de pointe — la méthode recommandée pour exécuter ShellGPT',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'auto-hébergé',
        description:
          'Pointez ShellGPT vers un point de terminaison local ou auto-hébergé compatible OpenAI (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Ouvre une page de vérification dans votre navigateur — ShellGPT se connecte automatiquement',
    ...
    authorizeThere: 'Autorisez ShellGPT là-bas.',
    ...
    autoBrowser: provider =>
      `Nous avons ouvert ${provider} dans votre navigateur. Autorisez ShellGPT là-bas et vous serez connecté automatiquement — rien à copier ou coller.`,
  ...
  freeTier: {
    ...
    busyBody: wait =>
      `ShellGPT n'a pas pu terminer votre connexion car le service Nous est occupé. Réessayez dans ${wait}. Votre session reste disponible entre-temps.`,
    unreachableBody:
      "ShellGPT n'a pas pu joindre le service Nous pour terminer votre connexion. Vérifiez votre connexion Internet et réessayez. Votre session reste disponible.",
    alreadySignedInHeading: 'Déjà connecté.',
    alreadySignedInBody: 'Cette installation ShellGPT est déjà connectée à un compte Nous.',
    setupFailed: {
      gateClosed:
        'Cette version de ShellGPT ne peut pas démarrer sans compte Nous. Connectez-vous ou créez-en un gratuitement en une minute.',
      paused:
        "L'utilisation de ShellGPT sans connexion est momentanément suspendue. ShellGPT continuera à vérifier. La connexion est gratuite et vous permet de continuer immédiatement.",
      rateLimited: wait =>
        `Beaucoup de personnes démarrent en ce moment ; ShellGPT réessaiera dans ${wait}. La connexion est gratuite et évite l'attente.`,
      unreachable:
        "ShellGPT n'a pas pu joindre le service Nous. Vérifiez votre connexion Internet, puis appuyez sur Réessayer. Vous pouvez aussi connecter un autre fournisseur.",
      serverError:
      ...
      generic:
        "ShellGPT n'a pas pu configurer l'accès gratuit sans connexion. Connectez-vous gratuitement ou choisissez un autre fournisseur.",
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} fait ${size}. ShellGPT n'affichera que les 512 Ko premiers.`,
    ...
    web: {
      ...
      tryAgain: 'Réessayer',
      restarting: 'ShellGPT redémarre...',
      askRestart: 'Demander à ShellGPT de redémarrer le serveur',
      lookingRestart: taskId => `ShellGPT recherche un serveur d'aperçu à redémarrer (${taskId})`,
      restartingTitle: "Redémarrage du serveur d'aperçu",
      restartingMessage: "ShellGPT travaille en arrière-plan. Surveillez la console d'aperçu pour suivre la progression.",
      ...
      blankPageBody: "Saisissez une adresse ci-dessus pour naviguer, ou demandez à ShellGPT d'ouvrir une page.",
      finishedRestarting: message =>
        `ShellGPT a terminé le redémarrage du serveur d'aperçu${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: "ShellGPT n'a pas pu redémarrer le serveur.",
      stillWorking:
        "ShellGPT travaille toujours, mais aucun résultat de redémarrage n'est arrivé. La commande du serveur peut être en cours d'exécution au premier plan.",
  ...
  interfaceMode: {
    ...
    hint: 'Modifie ce qui est affiché, pas ce que ShellGPT peut faire.',
    sessionNote:
      'Défini par le mode Simple. Une modification ici dure le temps de cette session ; passez en mode Avancé pour la conserver.',
    simple: {
      label: 'Simple',
      description:
        'Pour discuter avec ShellGPT. Barre latérale et conversation ; pas de panneaux terminal, fichiers ou diff.'
    },
    advanced: {
      label: 'Avancé',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'ShellGPT charge une réponse',
      ...
      errorLayerBodies: {
        ...
        disk: "Votre disque est plein ; ShellGPT n'a pas pu enregistrer cette conversation. Libérez de l'espace, puis réessayez.",
        endpoint:
          "ShellGPT ne parvient pas à joindre votre serveur de modèle personnalisé. Vérifiez qu'il fonctionne, puis renvoyez votre message.",
        gateway:
          'ShellGPT a rencontré un problème interne au démarrage de cette réponse. Renvoyez votre message ; si cela persiste, envoyez les diagnostics.',
        generic:
          "Une erreur s'est produite pendant la réponse de ShellGPT. Réessayez ou copiez les détails si cela persiste.",
        provider:
      ...
      errorCodes: {
        ...
        ssl_cert_verification: {
          ...
          body: provider =>
            `ShellGPT n'a pas pu vérifier la connexion sécurisée à ${provider}. Vérifiez votre réseau ou votre proxy, ou changez de fournisseur.`
        },
        context_overflow: {
        ...
        invalid_response: {
          ...
          body: provider => `${provider} a renvoyé une réponse que ShellGPT n'a pas pu lire. Réessayez dans un instant.`
        },
        empty_response: {
        ...
        loop_error: {
          title: 'ShellGPT est resté bloqué dans une boucle',
          body: 'La réponse répétait les mêmes étapes ; ShellGPT l’a donc arrêtée. Réessayez ou démarrez une nouvelle conversation.'
        },
        SESSION_NOT_OWNED: {
          title: 'Cette conversation est ouverte ailleurs',
          body: 'Cette conversation est déjà ouverte dans une autre fenêtre ShellGPT ou un terminal. Fermez-la là-bas puis réessayez, ou démarrez-en une nouvelle ici.'
        },
        disk_full: {
          title: 'Disque plein',
          body: "Votre disque est plein ; ShellGPT n'a pas pu enregistrer cette conversation. Libérez de l'espace puis réessayez."
        },
        free_tier_disabled: {
          title: "L'utilisation de ShellGPT sans connexion est désactivée pour le moment",
        ...
        free_tier_model_not_free: {
          ...
          body: 'ShellGPT utilise le modèle gratuit pour le moment. Connectez-vous avec un compte Nous gratuit pour accéder à plus de modèles.'
        },
        free_tier_route: {
          title: "ShellGPT n'a pas pu joindre le modèle gratuit par cette route",
        ...
        free_tier_refused: {
          title: "ShellGPT n'a pas pu envoyer ce message sans connexion",
      ...
      errorToastTitle: "ShellGPT n'a pas pu terminer la réponse",
      ...
      errorOpenShellGPTFolder: 'Ouvrir le dossier ShellGPT',
      errorOpenShellGPTFolderFailed: "Impossible d'ouvrir le dossier ShellGPT",
    ...
    approval: {
      gatewayDisconnected: "La Gateway ShellGPT n'est pas connectée",
      sendFailed: "Impossible d'envoyer la réponse d'approbation",
      reconnect: 'Se reconnecter',
      timedOutSystemLine:
        "Le délai d'approbation a expiré — la commande n'a pas été exécutée. Demandez à ShellGPT de réessayer ou augmentez la limite dans Paramètres → Sécurité → Délai d'approbation.",
      ...
      alwaysDescription: pattern =>
        `Cela ajoute le motif « ${pattern} » à votre liste d'autorisation permanente (~/.shellgpt/config.yaml). ShellGPT ne redemandera plus pour ce type de commande — que ce soit dans cette session ou dans une session future.`,
  ...
  prompts: {
    ...
    sudoDesc:
      "ShellGPT a besoin de votre mot de passe sudo pour exécuter une commande privilégiée. Il n'est envoyé qu'à votre agent local.",
    ...
    sudoInstallDesc:
      'ShellGPT a besoin de votre mot de passe sudo pour installer les paquets de Bot Screen (TigerVNC + Xfce) sur l’hôte du gateway. Il n’est envoyé qu’à cet hôte.',
    sudoPlaceholder: 'mot de passe sudo',
    secretTitle: 'Secret requis',
    secretDesc: "ShellGPT a besoin d'un identifiant pour continuer.",
    ...
    vaultSaveDesc: origin =>
      `ShellGPT a atteint une page de connexion sur ${origin} et ne possède aucun identifiant pour celle-ci. Saisissez-le une fois ici : il sera chiffré sur cet ordinateur et rempli dans la page sans que le modèle voie le mot de passe.`,
    ...
    vaultCodeDesc: site =>
      `${site} demande un code à usage unique reçu par SMS, e-mail ou application d'authentification. Saisissez-le ici : ShellGPT le remplira dans la page sans que le modèle le voie.`,
    vaultCodeLabel: 'Code',
    vaultCodeFootnote:
      "Astuce : enregistrez la clé d'authentification avec cet identifiant dans Paramètres → Mots de passe et identifiants ; ShellGPT saisira alors les codes pour vous.",
  ...
  desktop: {
    ...
    restartToUseSaveImage: "Redémarrez ShellGPT Desktop pour utiliser Enregistrer l'image.",
    restartToSaveImages: 'Redémarrez ShellGPT Desktop pour enregistrer les images',
    ...
    handoff: {
      ...
      timedOut: "Délai d'expiration en attendant la Gateway. `shellgpt gateway` est-il en cours d'exécution ?",
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        ...
        text: "Les compétences sont des dossiers d'instructions que ShellGPT charge lorsque le travail le nécessite."
      },
      messaging: {
        title: 'ShellGPT loin de votre bureau',
        text: 'Connectez Telegram, Discord, Slack et plus encore : même agent, même mémoire.'
      },
      artifacts: {
        title: 'Tout ce que ShellGPT a créé',
      ...
      profiles: {
        ...
        text: 'Chacun possède son propre ShellGPT, avec ses clés, sa mémoire et ses sessions.'
      },
      'composer-mentions': {
