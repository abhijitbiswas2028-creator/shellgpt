...
import { McpSetupButton } from '@/plugins/shellgpt-bots/mcp-setup'
import { AdvancedProfileConfig, applyAdvancedConfig, emptyAdvancedState } from '@/plugins/shellgpt-bots/profile-config'
