...
// (#73044). Exercises the REAL shellgpt + store/gateway + store/profile chain:
...
const { pluginSocket, setApiRequestConnection, setApiRequestProfile } = await import('@/shellgpt')
