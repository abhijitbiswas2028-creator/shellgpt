...
// v1 (`shellgpt.desktop.statusbarHidden`) was seeded with the approval pill
...
const STATUSBAR_HIDDEN_STORAGE_KEY = 'shellgpt.desktop.statusbarHidden.v2'
const LEGACY_HIDDEN_STORAGE_KEY = 'shellgpt.desktop.statusbarHidden'
// v1 (`shellgpt.desktop.statusbarVisible`) shipped a stretch where the bar was
...
const STATUSBAR_VISIBLE_STORAGE_KEY = 'shellgpt.desktop.statusbarVisible.v2'
