...
import { getShellGPTConfigRecord, type McpTestResult, setMcpServerEnabled, testMcpServer } from '@/shellgpt'
...
const SNOOZE_KEY_PREFIX = 'shellgpt:mcp-health-snooze-until:'
...
async function sweep(): Promise<void> {
  ...
  try {
    config = await getShellGPTConfigRecord()
  } catch {
