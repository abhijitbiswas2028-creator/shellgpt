 ...
 * - It covers ShellGPT too. "Off" from someone who has just closed a bubble means
...
const ENABLED_KEY = 'shellgpt.desktop.tips.rotation.v1'

export const $tipsEnabled = persistentAtom(ENABLED_KEY, true, Codecs.bool)
export const $retiredTips = persistentAtom<string[]>('shellgpt.desktop.tips.retired.v1', [], Codecs.stringArray)
export const $lastTipId = persistentAtom<null | string>('shellgpt.desktop.tips.last.v1', null, Codecs.nullableText)
export const $nextTipAt = persistentAtom<null | number>(
  'shellgpt.desktop.tips.next.v1',
  null,
...
export const $tipShownAt = persistentAtom<Record<string, number>>(
  'shellgpt.desktop.tips.shownAt.v1',
  {},
  Codecs.json(value => {
