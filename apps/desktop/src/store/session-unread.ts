...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('shellgpt.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('shellgpt.desktop.unreadFinishedSessions')
