...
export interface PetInfo {
  ...
  // the ShellGPT "run" activity state uses the in-place running row).
 ...
 * SHELLGPT_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'shellgpt.desktop.pet-roam.v1'
