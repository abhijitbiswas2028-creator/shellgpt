...
describe('remoteHostLabel', () => {
  it('keeps a non-default port and drops default ones', () => {
    expect(remoteHostLabel('https://shellgpt.example.com:8443/x')).toBe('shellgpt.example.com:8443')
    expect(remoteHostLabel('https://shellgpt.example.com:443')).toBe('shellgpt.example.com')
    expect(remoteHostLabel('http://shellgpt.example.com:80')).toBe('shellgpt.example.com')
  })
