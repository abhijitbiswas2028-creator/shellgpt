 ...
 * `<shellgpt home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'shellgpt.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'shellgpt.desktop.disabledPlugins.v1'
