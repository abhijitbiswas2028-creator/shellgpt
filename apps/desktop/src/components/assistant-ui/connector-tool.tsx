...
import type { ConnectionTargetState, ConnectorsConnectResult } from '@shellgpt/shared'
...
/** The browser leg of a connection came back through `shellgpt://connections/done`. Show the session
          ...
          const action =
            phase.verb === 'none'
              ...
              : {
                  ...
                  onClick: () => {
                    if (phase.verb === 'open' && target.connectUrl && window.shellgptDesktop?.openExternal) {
                      void window.shellgptDesktop.openExternal(target.connectUrl)
