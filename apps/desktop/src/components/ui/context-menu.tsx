...
export const SHELLGPT_CONTEXT_MENU_TRIGGER_ATTR = 'data-shellgpt-context-menu-trigger'

function ContextMenuTrigger({ ...props }: React.ComponentProps<typeof ContextMenuPrimitive.Trigger>) {
  return (
    <ContextMenuPrimitive.Trigger data-slot="context-menu-trigger" {...props} data-shellgpt-context-menu-trigger="" />
  )
}
