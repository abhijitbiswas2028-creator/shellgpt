...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should ShellGPT look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} ShellGPT need to see?`,
    ...
    {
      headline: `What should ${label} ShellGPT tackle?`,
