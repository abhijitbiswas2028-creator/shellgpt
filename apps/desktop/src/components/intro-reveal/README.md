...
Electron sets the flag from `SHELLGPT_GUEST_ONBOARDING=1` or `--guest-onboarding`.
...
`SHELLGPT_SKIP_INTRO=1` turns the film off but keeps the guided chat: the gate
