...
// Connectors are the apps ShellGPT reads and acts on for the user. Chat channels
// (Discord, Telegram, WhatsApp) are how a user talks to ShellGPT; those live on
...
// place a single question can answer both: someone here to talk to ShellGPT
...
export const LAYOUTS: Array<{ description: string; id: string; mode: InterfaceMode; name: string; tree: MiniNode }> = [
  {
    description: 'For talking to ShellGPT.',
    id: 'sidebar-left',
    mode: 'simple',
    name: 'Basic',
