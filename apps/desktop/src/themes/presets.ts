...
import { THEME_PRESET_PALETTES } from '@shellgpt/shared'
...
/**
 * Nous — the canonical ShellGPT desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays ShellGPT's own: a VS Code theme carries no font opinion, and
...
/**
 * Nous — the canonical ShellGPT desktop identity: GitHub's chrome carrying Nous
