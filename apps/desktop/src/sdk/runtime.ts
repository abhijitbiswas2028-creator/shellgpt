 ...
 * plugins resolve `@shellgpt/plugin-sdk` through the vite alias; RUNTIME-loaded
...
// `sdk/runtime` — so a module-scope `{ __SHELLGPT_PLUGIN_SDK__: sdk, … }` is
...
// `Object.keys(GLOBALS.__SHELLGPT_PLUGIN_SDK__)` threw
...
function pluginNamespaces() {
  return {
    __SHELLGPT_PLUGIN_SDK__: sdk,
    __SHELLGPT_REACT__: React,
    __SHELLGPT_REACT_JSX__: jsxRuntime,
    __SHELLGPT_REACT_JSX_DEV__: jsxDevRuntime
  }
}
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@shellgpt/plugin-sdk': shimUrl('__SHELLGPT_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__SHELLGPT_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__SHELLGPT_REACT_JSX__'),
    react: shimUrl('__SHELLGPT_REACT__')
  }
