...
const relaySource = readFileSync(join(process.cwd(), 'src/plugins/shellgpt-bots/relay.ts'), 'utf8')
const repoRoot = join(process.cwd(), '..', '..')
const configDefaults = readFileSync(join(repoRoot, 'shellgpt_cli/config_defaults.py'), 'utf8')
