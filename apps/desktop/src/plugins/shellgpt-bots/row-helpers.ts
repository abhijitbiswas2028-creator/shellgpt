...
import { atom, host, useValue } from '@shellgpt/plugin-sdk'
...
export function previewKind(preview: null | string | undefined): { fromBot: null | string } {
  ...
  if (match) {
    ...
    // profile reads @shellgpt, never @default (#89484).
 ...
 *  (shellgpt-agent#90268). Older gateways omit worker_session — always false. */
