...
import { Codicon, host, useValue } from '@shellgpt/plugin-sdk'
import type { RpcEvent } from '@shellgpt/plugin-sdk'
import type { ProfileGroupRoute } from '@shellgpt/plugin-sdk'
...
export function useScreenPortalState(bot: RosterRow) {
  ...
  useEffect(() => {
    ...
    void displayRequest<DisplayStatus>(bot, 'display.status')
      ...
      .catch((error: unknown) => {
        // An older ShellGPT without display.* is a settled answer (hide the surface);
