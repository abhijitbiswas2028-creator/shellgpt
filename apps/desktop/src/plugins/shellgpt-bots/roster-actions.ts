...
import { ackStoredSessionId, atom, haptic, host, markSessionUnreadFinished } from '@shellgpt/plugin-sdk'
 ...
 *  (shellgpt-agent#90102) and are discarded. Without `canonical_session` (older
