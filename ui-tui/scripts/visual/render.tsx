 ...
 * across theme x background scenes to <tmpdir>/shellgpt-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@shellgpt/ink'
...
// The regenerated slate light_colors block from shellgpt_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/shellgpt-agent',
...
const setup = (bgHex: string) => {
  process.env.SHELLGPT_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
