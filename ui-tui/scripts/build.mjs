...
await build({
  ...
  // Skip the prebuilt @shellgpt/ink bundle and inline the source instead:
  ...
  alias: { '@shellgpt/ink': resolve(root, 'packages/shellgpt-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The shellgpt_cli launcher
