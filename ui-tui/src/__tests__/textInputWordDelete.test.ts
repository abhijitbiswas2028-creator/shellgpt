...
import { InputEvent } from '../../packages/shellgpt-ink/src/ink/events/input-event.js'
import { INITIAL_STATE, parseMultipleKeypresses } from '../../packages/shellgpt-ink/src/ink/parse-keypress.js'
...
// web/src/lib/pty-keyboard-shortcuts.ts). shellgpt-ink decodes that bare
