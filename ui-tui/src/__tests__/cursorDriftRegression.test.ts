 ...
 *
 * Symptom: in `shellgpt --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@shellgpt/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using shellgpt --tui and as i type multiline my caret at the end will often ' +
