...
import type { ScrollBoxHandle } from '@shellgpt/ink'
import { evictInkCaches } from '@shellgpt/ink'
import type { InflightTurn, SessionResumeResult, Usage } from '@shellgpt/shared/gateway-events'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.SHELLGPT_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
