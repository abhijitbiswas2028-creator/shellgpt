...
def install_tui_message_injector(manager=None) -> None:
    ...
    """
    from shellgpt_cli.plugins import get_plugin_manager, publish_tui_message_host
...
def clear_tui_message_injector(manager=None) -> None:
    ...
    from shellgpt_cli.plugins import clear_published_tui_message_host, get_plugin_manager
