...
_WORKER_UNAVAILABLE = "Group Chat worker is unavailable. Restart the ShellGPT gateway and try again."
...
def _profile_name() -> str:
    return (os.getenv("SHELLGPT_PROFILE") or "default").strip() or "default"
