...
def _state_dir() -> Path:
    ...
    # Default: $SHELLGPT_HOME/watcher-state/, falling back to ~/.shellgpt/watcher-state/.
    shellgpt_home = os.environ.get("SHELLGPT_HOME") or str(Path.home() / ".shellgpt")
    return Path(shellgpt_home) / "watcher-state"
