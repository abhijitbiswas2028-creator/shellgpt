...
curl -fsSL "https://github.com/ast-grep/ast-grep/releases/download/${VERSION}/app-${TRIPLE}.zip" -o ~/.shellgpt/cache/scratch/ast-grep.zip
unzip ~/.shellgpt/cache/scratch/ast-grep.zip -d ~/.shellgpt/cache/scratch/ast-grep
sudo mv ~/.shellgpt/cache/scratch/ast-grep/ast-grep /usr/local/bin/sg
