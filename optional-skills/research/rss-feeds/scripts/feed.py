...
Standard library only, so it runs in any ShellGPT environment without an install
...
USER_AGENT = "shellgpt-agent/1.0 (rss-feeds skill; +https://github.com/NousResearch/shellgpt-agent)"
TIMEOUT = 20
NS = {
