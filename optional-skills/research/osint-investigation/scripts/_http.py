...
DEFAULT_UA = (
    "shellgpt-osint-investigation/0.2 "
    "(+https://github.com/NousResearch/shellgpt-agent; "
    "set SHELLGPT_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("SHELLGPT_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
