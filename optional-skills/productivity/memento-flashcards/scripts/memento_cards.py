...
Data file: $SHELLGPT_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_SHELLGPT_HOME = Path(os.environ.get("SHELLGPT_HOME", Path.home() / ".shellgpt"))
DATA_DIR = _SHELLGPT_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
