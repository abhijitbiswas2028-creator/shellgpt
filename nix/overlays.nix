# nix/overlays.nix — Expose pkgs.shellgpt-agent for external NixOS configs
#
...
# `pkgs.shellgpt-agent`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    shellgpt-agent = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
