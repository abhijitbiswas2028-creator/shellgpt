...
let
      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via SHELLGPT_BUNDLED_SKILLS /
            # SHELLGPT_OPTIONAL_SKILLS (see shellgpt-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + SHELLGPT_BUNDLED_LOCALES
            # / SHELLGPT_OPTIONAL_MCPS, not via the wheel. Excluding them
  ...
  #
  # Usage:
  #   shellgptNpmLib.buildNpmPackage {
