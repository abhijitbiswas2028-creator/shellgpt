...
Every table in ShellGPT lives here. A directory literal outside this module fails the ratchet in
...
def shellgpt_vendored_dirs() -> tuple[str, ...]:
    return ("~/.shellgpt/bin",) if _POSIX else ("%USERPROFILE%/.shellgpt/bin",)
