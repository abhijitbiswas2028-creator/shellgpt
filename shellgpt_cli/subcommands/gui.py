"""``shellgpt gui`` subcommand parser."""
...
def build_gui_parser(subparsers, *, cmd_gui: Callable) -> None:
    ...
    gui_parser = subparsers.add_parser(
        ...
        description="Launch the ShellGPT Electron desktop app. By default this installs "
    ...
    gui_parser.add_argument(
        ...
        help="Force Desktop to ignore any shellgpt CLI already on PATH during backend resolution")
    gui_parser.add_argument(
        "--shellgpt-root",
        help="Override the ShellGPT source root used by Desktop (sets SHELLGPT_DESKTOP_SHELLGPT_ROOT)")
    gui_parser.add_argument(
        "--cwd",
        help="Initial project directory for Desktop chat sessions (sets SHELLGPT_DESKTOP_CWD)")
    gui_parser.add_argument(
    ...
    gui_parser.add_argument(
        "--identity", default="ShellGPT Local Signing",
        help="Certificate name to create/use for --setup-tcc-identity (default: ShellGPT Local Signing)",
    )
