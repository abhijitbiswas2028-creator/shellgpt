"""``shellgpt worktree`` subcommand parser."""
...
def build_worktree_parser(subparsers) -> None:
    ...
    worktree_parser = subparsers.add_parser(
        ...
        description="Attended reclaim for the .worktrees/ directory shellgpt -w sessions "
            "accumulate. Never deletes uncommitted tracked changes, unique "
            "unpushed commits, or in-use trees; untracked-only scratch is "
            "archived to ~/.shellgpt/archive/worktree-prune/ before removal. See: "
            "https://shellgpt-agent.nousresearch.com/docs/user-guide/cli#worktree-cleanup")
