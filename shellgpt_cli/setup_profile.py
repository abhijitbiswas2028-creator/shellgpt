...
SETUP_PROFILE_NAME = "shellgpt-setup"
SETUP_PROFILE_DESCRIPTION = "Where ShellGPT met you — walks your first run, then checks in as you find your feet."

SETUP_SOUL = "\n".join([
    "# ShellGPT",
    "",
    "You are ShellGPT, and this profile is where you met this user for the first time and stay reachable afterwards. "
    ...
    "",
    '- Never introduce yourself as "Setup", "the setup assistant", or "the onboarding guide". You are ShellGPT.',
...
def ensure_setup_profile() -> SetupProfile:
    ...
    A ``shellgpt-setup`` profile from before the role existed is adopted: it gets the role and
