...
def run_whatsapp_cloud_setup() -> int:
    ...
    _lines(
        ...
        "This wizard configures ShellGPT to talk to WhatsApp via Meta's",
    ...
    _lines(
        "", "  ShellGPT needs a public HTTPS URL to receive WhatsApp messages.",
        ...
        "    3. Start the ShellGPT gateway in another terminal:",
        "         shellgpt gateway", "",
    ...
    _lines(
        ...
        "  Docs: https://shellgpt-agent.nousresearch.com/docs/user-guide/",
