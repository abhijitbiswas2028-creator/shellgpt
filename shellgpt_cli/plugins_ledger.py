...
reload / targeted unload unwind registries in reverse order. Mixed into :class:`shellgpt_cli.plugins.PluginManager`.
"""
...
from shellgpt_cli.plugins_loader import _plugin_home_scope
from shellgpt_cli.plugins_manifest import PluginManifest, manifest_key
...
class PluginLedgerMixin:
    ...
    def _dispose_registrations(self, registrations: List[PluginRegistration]) -> None:
        ...
        from shellgpt_cli.plugins import _PLUGINS_DEBUG
