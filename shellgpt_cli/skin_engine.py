"""ShellGPT skin/theme engine — the theme SDK for every surface."""
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces SHELLGPT_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces SHELLGPT_CADUCEUS)
...
# Branding shared by every ShellGPT-named built-in (mono/daylight override help_header).
_SHELLGPT_BRANDING: Dict[str, str] = _branding(
    "ShellGPT", "☤", "Goodbye! ☤", prompt="❯", help_header="(^_^)? Available Commands")

_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default", "description": "Classic ShellGPT — gold and kawaii",
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "mono": {
        ...
        "spinner": {},
        "branding": {**_SHELLGPT_BRANDING, "help_header": "[?] Available Commands"},
        "tool_prefix": "┊"},
    "slate": {
        ...
        "spinner": {}, "branding": _SHELLGPT_BRANDING, "tool_prefix": "┊"},
    "daylight": {
        "name": "daylight",
...
def _routed_home_key() -> Optional[str]:
    ...
    return None if get_shellgpt_home_override() is None else shellgpt_home_key()
...
def _skins_dir() -> Path:
    return get_shellgpt_home() / "skins"
