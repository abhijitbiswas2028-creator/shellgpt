"""Relay subscriber for the persisted ShellGPT shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated ShellGPT counters from Relay lifecycle events."""

    def __init__(
        self,
        store: SharedMetricsStore,
        shellgpt_version: str,
        *,
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the ShellGPT shared metric: %s", metric_name, exc_info=True
                )
