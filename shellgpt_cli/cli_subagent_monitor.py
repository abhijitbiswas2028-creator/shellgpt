...
from shellgpt_cli import cli_process_dock as procs
from shellgpt_cli import cli_session_dock as session_rows
...
class SubagentMonitor:
    ...
    def invalidate(self):
        from shellgpt_cli.cli_terminal_mixin import _run_on_app_loop
