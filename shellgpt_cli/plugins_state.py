"""Plugin-owned durable state and namespaced settings helpers (split out of shellgpt_cli.plugins)."""
...
from shellgpt_cli.plugins_manifest import _portable_skill_namespace
...
class PluginState:
    ...
    def data_dir(self) -> Path:
        ...
        return get_shellgpt_home() / "plugin-data" / self._data_namespace
