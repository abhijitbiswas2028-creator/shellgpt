"""Non-interactive HTTPS credentials for ShellGPT's internal git clones (private plugin/MCP/profile repos).
...
repo the user can already clone from their shell fails inside ``shellgpt plugins install`` with
...
from shellgpt_cli._subprocess_compat import noninteractive_git_env, windows_hide_flags
