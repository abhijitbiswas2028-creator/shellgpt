...
def _run_state_db_auto_maintenance(session_db) -> None:
    ...
    try:
        ...
        from shellgpt_constants import get_shellgpt_home as _get_shellgpt_home  # lazy: tests patch it
        _shellgpt_home_maint = _get_shellgpt_home()
        ...
        for meta_key, repair, done_msg, skip_msg in (
            (
                ...
                lambda: session_db.prune_empty_ghost_sessions(sessions_dir=_shellgpt_home_maint / "sessions"),
        ...
        session_db.maybe_auto_prune_and_vacuum(
            ...
            sessions_dir=_shellgpt_home_maint / "sessions",
        )
