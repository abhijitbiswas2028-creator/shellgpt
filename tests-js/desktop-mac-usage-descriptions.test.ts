 ...
 *
 * Each entry is a key/value pair that lands in the packaged ShellGPT.app's
 ...
 * "ShellGPT wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("ShellGPT wants to access Music" when ShellGPT never touches the Music
