...
# containing `cat ~/.shellgpt/.env` or `rm -rf /`; there it is a smoking gun, not prose.
...
# `shellgpt-agent-dev` skill contains a security postmortem mentioning `cat ~/.shellgpt/.env`, which tripped
