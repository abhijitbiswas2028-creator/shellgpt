...
`hey_shellgpt.onnx` / `hey_shellgpt.tflite` — the on-device "Hey ShellGPT" hotword
...
- **Label:** the model registers as `hey_shellgpt` (matches the filename).
