...
started by `shellgpt mcp login/reauth`, never a background reconnect.
"""
...
async def login_device(name, server_url, oauth_config):
    ...
    from tools.mcp_oauth_manager import ShellGPTMCPOAuthProvider, get_manager
    ...
    provider = ShellGPTMCPOAuthProvider(server_url=server_url, server_name=name, storage=storage,
