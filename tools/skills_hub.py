...
Used by shellgpt_cli/skills_hub.py for CLI commands and the /skills slash command.
"""
...
_skills_dir = _path_resolver("SKILLS_DIR", "SHELLGPT_HOME", "skills")
...
_DYNAMIC_PATH_RESOLVERS = {"SHELLGPT_HOME": _shellgpt_home, **{
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'SHELLGPT_INDEX_TTL': ('tools.skills_hub_search', 'SHELLGPT_INDEX_TTL'),
    'SHELLGPT_INDEX_URL': ('tools.skills_hub_search', 'SHELLGPT_INDEX_URL'),
    'ShellGPTIndexSource': ('tools.skills_hub_official', 'ShellGPTIndexSource'),
