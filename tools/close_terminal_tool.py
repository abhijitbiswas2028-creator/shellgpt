"""Close a read-only agent terminal tab in the ShellGPT desktop GUI WITHOUT killing
...
CLOSE_TERMINAL_SCHEMA = {
    ...
    "description": (
        ...
        "the ShellGPT desktop GUI (the tabs mirroring terminal(background=true) runs). "
