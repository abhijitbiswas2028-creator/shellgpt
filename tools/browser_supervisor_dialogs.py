...
DIALOG_BRIDGE_HOST = "shellgpt-dialog-bridge.invalid"
...
(() => {
  if (window.__shellgptDialogBridgeInstalled) return;
  window.__shellgptDialogBridgeInstalled = true;
  const ENDPOINT = "http://shellgpt-dialog-bridge.invalid/";
